...
public class Command {
    ...
    public static Map<Integer, ICmdHandler> getValidCommandList() {
        ...
        if (map == null || map.size() == 0) {
            ...
            a.put(Integer.valueOf(CMD_NOTIFY_DEVICE_APP_INFO), new NotifyAppInfoCmdHandler());
            a.put(209, new SettingsMtuCmdHandler());
            a.put(Integer.valueOf(CMD_PHONE_NUMBER_PLAY_MODE), new NotifyPhoneNumberPlayModeCmdHandler());
            a.put(Integer.valueOf(CMD_SET_DEVICE_STORAGE), new SetDevStorageCmdHandler());
            a.put(Integer.valueOf(CMD_GET_DEVICE_CONFIG_INFO), new GetDevConfigureCmdHandler());
            a.put(240, new RcspCmdHandler());
            a.put(255, new CustomCmdHandler());
            a.put(Integer.valueOf(CMD_GET_EXTERNAL_FLASH_MSG), new ExternalFlashCmdHandler());
            a.put(26, new ExternalFlashCmdHandler());
            a.put(27, new LargeFileTransferCmdHandler());
            a.put(28, new LargeFileTransferCmdHandler());
            a.put(29, new LargeFileTransferCmdHandler());
            a.put(32, new LargeFileTransferCmdHandler());
            a.put(30, new LargeFileTransferCmdHandler());
            a.put(33, new LargeFileTransferCmdHandler());
            a.put(22, new FileTransferCmdHandler());
            a.put(23, new FileTransferCmdHandler());
            a.put(24, new FileTransferCmdHandler());
            a.put(12, new FileBrowseCmdHandler());
            a.put(13, new FileBrowseCmdHandler());
            a.put(31, new FileBrowseCmdHandler());
            a.put(35, new FileBrowseCmdHandler());
            a.put(15, new LrcCmdHandler());
            a.put(16, new LrcCmdHandler());
            a.put(17, new LrcCmdHandler());
            a.put(34, new FileBrowseCmdHandler());
            a.put(Integer.valueOf(CMD_NOTIFY_FILE_STRUCTURE_CHANGE), new FileBrowseCmdHandler());
            a.put(36, new ReadFileFromDeviceCmdHandler());
            a.put(161, new HealthDataCmdHandler());
            a.put(162, new HealthDataCmdHandler());
            a.put(163, new HealthDataCmdHandler());
            a.put(37, new AlarmExpandCmdHandler());
            a.put(38, new BatchHandler());
            a.put(39, new DeviceExtendParamCmdHandler());
            a.put(4, new SpeechCmdHandler());
            a.put(5, new SpeechCmdHandler());
            a.put(Integer.valueOf(CMD_RECEIVE_SPEECH_CANCEL), new SpeechCmdHandler());
            a.put(Integer.valueOf(CMD_GET_LOW_LATENCY_SETTINGS), new GetLowLatencySettingsCmdHandler());
            a.put(192, new TwsCmdHandler());
            a.put(193, new TwsCmdHandler());
            a.put(194, new TwsCmdHandler());
            a.put(195, new TwsCmdHandler());
            a.put(196, new TwsCmdHandler());
            a.put(25, new SearchDevCmdHandler());
            a.put(160, new HealthDataCmdHandler());
            a.put(164, new NFCOperationCmdHandler());
            a.put(165, new HealthSettingCmdHandler());
            a.put(166, new SportsInfoStatusCmdHandler());
            a.put(40, new SmallFileTransferCmdHandler());
            a.put(41, new ReadErrorMsgCmdHandler());
            a.put(48, new DataTransferCmdHandler());
            a.put(49, new QueryPhoneBtInfoCmdHandler());
            a.put(50, new AiOperateCmdHandler());
            a.put(51, new PublicSettingsCmdHandler());
        }
        return a;
    }
