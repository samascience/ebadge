...
public class CommandBuilder {
    ...
    public static CommandBase buildGetSoundCardEqInfo() {
        return buildGetPublicSysInfoCmd(Opcodes.ASM6);
    }

    public static CommandBase buildGetSoundCardStatusInfo() {
        return buildGetPublicSysInfoCmd(Opcodes.ASM8);
    }
    ...
    public static CommandBase buildSetCurrentVoiceMode(VoiceMode voiceMode) {
        ...
        AttrBean attrBean = new AttrBean();
        attrBean.setType(AttrAndFunCode.SYS_INFO_ATTR_CURRENT_NOISE_MODE);
    ...
    public static CommandBase buildSetFixedLenDataCmd(int i, byte[] bArr) {
        ...
        byte[] bArrIntToBigBytes = CHexConver.intToBigBytes(i);
        System.arraycopy(bArrIntToBigBytes, 0, bArr2, 0, bArrIntToBigBytes.length);
        System.arraycopy(bArr, 0, bArr2, bArrIntToBigBytes.length, bArr.length);
        AttrBean attrBean = new AttrBean();
        attrBean.setType(AttrAndFunCode.SYS_INFO_ATTR_FIXED_LEN_DATA_FUN);
        attrBean.setAttrData(bArr2);
        arrayList.add(attrBean);
        return buildSetSysInfoCmd((byte) -1, arrayList);
    }
    ...
    public static CommandBase buildSetHighAndBassCmd(int i, int i2) {
        ArrayList arrayList = new ArrayList();
        AttrBean attrBean = new AttrBean();
        attrBean.setType(AttrAndFunCode.SYS_INFO_ATTR_HIGH_AND_BASS);
        byte[] bArr = new byte[8];
        byte[] bArrIntToBigBytes = CHexConver.intToBigBytes(i);
        System.arraycopy(CHexConver.intToBigBytes(i2), 0, bArr, 0, 4);
        System.arraycopy(bArrIntToBigBytes, 0, bArr, 4, 4);
        attrBean.setAttrData(bArr);
        arrayList.add(attrBean);
        return buildSetSysInfoCmd((byte) -1, arrayList);
    }
    ...
    public static CommandBase buildSetSoundCardEqValue(byte[] bArr) {
        AttrBean attrBean = new AttrBean();
        attrBean.setType(AttrAndFunCode.SYS_INFO_ATTR_SOUND_CARD_EQ_GAIN);
    ...
    public static CommandBase buildSetSoundCardInfo(byte b, int i) {
        AttrBean attrBean = new AttrBean();
        attrBean.setType(AttrAndFunCode.SYS_INFO_ATTR_SOUND_CARD);
