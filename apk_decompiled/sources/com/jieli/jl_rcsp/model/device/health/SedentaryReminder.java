...
public class SedentaryReminder implements IHealthSettingToAttr {
    ...
    private byte[] toData() {
        ...
        byteBufferAllocate.put(this.status).put(this.mode).put(this.freeLunchBreak ? (byte) 1 : (byte) 0).put(this.startHour).put(this.startMin).put(this.endHour).put(this.endMin);
