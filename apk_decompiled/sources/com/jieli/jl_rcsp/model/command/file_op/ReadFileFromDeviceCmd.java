...
public class ReadFileFromDeviceCmd extends CommandWithParamAndResponse<Param, Response> {
    ...
    public static class StartWithClusterParam extends Param {
        ...
        public byte[] getParamData() {
            ...
            byteBufferAllocate.put(this.op).putInt(this.devHandler).putInt(this.offset).putInt(this.cluster);
    ...
    public static class StartWithDevAndNameParam extends Param {
        ...
        public byte[] getParamData() {
            ...
            ByteBuffer byteBufferAllocate = ByteBuffer.allocate(nameData.length + 10);
            byteBufferAllocate.put(this.op).putInt(this.devHandler).putInt(this.offset).put((byte) nameData.length).put(nameData);
            return byteBufferAllocate.array();
        }
    ...
    public static class StartWithNameParam extends Param {
        ...
        public byte[] getParamData() {
            byte[] nameData = Param.getNameData(this.name, this.unicode);
            ByteBuffer byteBufferAllocate = ByteBuffer.allocate(nameData.length + 5);
            byteBufferAllocate.put(this.op).putInt(this.offset).put(nameData);
            return byteBufferAllocate.array();
        }
