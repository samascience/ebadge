                ...
                switch (opCode) {
                    ...
                    case 229:
                        if (paramData == null || paramData.length < 6) {
                            ...
                            iBytesToInt4 = CHexConver.bytesToInt(bArr2);
                            iBytesToInt2 = CHexConver.bytesToInt(paramData[4], paramData[5]);
                        }
                        return new FirmwareUpdateBlockCmd(new FirmwareUpdateBlockParam(iBytesToInt4, iBytesToInt2)).setOpCodeSn(basePacket.getOpCodeSn());
                    case 230:
                        return new FirmwareUpdateStatusCmd().setOpCodeSn(basePacket.getOpCodeSn());
                    case 231:
                        if (paramData != null && paramData.length > 0) {
                            iBytesToInt4 = CHexConver.byteToInt(paramData[0]);
                        }
                        return new RebootDeviceCmd(new RebootDeviceParam(iBytesToInt4)).setOpCodeSn(basePacket.getOpCodeSn());
                    case 232:
                        if (paramData == null || paramData.length < 4) {
                            ...
                            if (paramData.length >= 8) {
                                ...
                                iBytesToInt4 = CHexConver.bytesToInt(bArr3);
                            }
                        }
                        return new NotifyUpdateContentSizeCmd(new NotifyUpdateContentSizeParam(iBytesToInt3).setCurrentProgress(iBytesToInt4)).setOpCodeSn(basePacket.getOpCodeSn());
                }
            }
            ...
            switch (opCode) {
                case 225:
                    if (paramData == null || paramData.length < 6) {
                        ...
                        iBytesToInt4 = CHexConver.bytesToInt(bArr4);
                    ...
                    updateFileOffsetResponse.setUpdateFileFlagOffset(iBytesToInt4);
                    updateFileOffsetResponse.setUpdateFileFlagLen(iBytesToInt);
                    if (command != null) {
                ...
                case 228:
                    ...
                    ExitUpdateModeResponse exitUpdateModeResponse = new ExitUpdateModeResponse(iBytesToInt4);
