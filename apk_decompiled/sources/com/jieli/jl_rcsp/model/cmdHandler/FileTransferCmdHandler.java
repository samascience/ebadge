    ...
    public CommandBase parseDataToCmd(BluetoothDevice bluetoothDevice, BasePacket basePacket) {
        ...
        if (opCode == 22 || opCode == 23 || opCode == 24) {
            ...
            if (basePacket.getType() == 1) {
                switch (opCode) {
                    case 22:
                        ...
                        StartFileTransferParam startFileTransferParam = new StartFileTransferParam(str, iBytesToInt);
                    ...
                    case 23:
                        ...
                        return new StopFileTransferCmd(new StopFileTransferParam(iByteToInt)).setOpCodeSn(basePacket.getOpCodeSn());
                    case 24:
                        if (paramData != null && paramData.length > 0) {
                            iByteToInt = CHexConver.byteToInt(paramData[0]);
                        }
                        return new NotifyFileTransferOpCmd(new NotifyFileTransferParam(iByteToInt)).setOpCodeSn(basePacket.getOpCodeSn());
                }
            }
            ...
            switch (opCode) {
                ...
                case 23:
                    int iByteToInt2 = (paramData == null || paramData.length <= 0) ? 0 : CHexConver.byteToInt(paramData[0]);
                    ...
                    stopFileTransferResponse.setReason(iByteToInt2);
                    if (command != null) {
