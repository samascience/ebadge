        ...
        if (opCode == 192 || opCode == 193 || opCode == 194 || opCode == 195 || opCode == 196) {
                ...
                switch (opCode) {
                    ...
                    case 193:
                        if (paramData != null && paramData.length >= 4) {
                            ...
                            iBytesToInt = CHexConver.bytesToInt(bArr);
                        }
                        return new GetADVInfoCmd(new GetADVInfoParam(iBytesToInt)).setOpCodeSn(basePacket.getOpCodeSn());
                    case 194:
                    ...
                    case 195:
                        if (paramData != null && paramData.length > 0) {
                            iBytesToInt = CHexConver.byteToInt(paramData[0]);
                        }
                        return new SetDeviceNotifyAdvInfoCmd(new SetDeviceNotifyAdvInfoParam(iBytesToInt)).setOpCodeSn(basePacket.getOpCodeSn());
                    case 196:
                        if (paramData != null && paramData.length > 0) {
                            iBytesToInt = CHexConver.byteToInt(paramData[0]);
                        }
                        return new RequestAdvOpCmd(new RequestAdvOpParam(iBytesToInt)).setOpCodeSn(basePacket.getOpCodeSn());
                }
            }
            ...
            switch (opCode) {
                case 192:
                    ...
                    SetADVResponse setADVResponse = new SetADVResponse(iByteToInt);
                ...
                case 195:
                    ...
                    SetDeviceNotifyAdvInfoResponse setDeviceNotifyAdvInfoResponse = new SetDeviceNotifyAdvInfoResponse(iByteToInt);
