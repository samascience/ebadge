...
public abstract class FromStringDeserializer<T> extends StdScalarDeserializer<T> {
    ...
    public static class Std extends FromStringDeserializer<Object> {
        ...
        private Locale _deSerializeBCP47Locale(String str, int i, String str2, String str3, int i2) {
            ...
            if (i2 > 0 && i2 > i) {
                try {
                    ...
                    return new Locale(str2, str3, Constants.STR_EMPTY);
                }
            }
            ...
            switch (this._kind) {
                ...
                case 4:
                    try {
                        ...
                        return deserializationContext.handleInstantiationProblem(this._valueClass, str, ay.F(e));
                    }
                case 5:
        ...
        public Object getEmptyValue(DeserializationContext deserializationContext) throws JsonMappingException {
            ...
            return URI.create(Constants.STR_EMPTY);
        }
    }
    ...
    static class StringBufferDeserializer extends FromStringDeserializer<Object> {
        ...
        public Object deserialize(JsonParser jsonParser, DeserializationContext deserializationContext) throws IOException {
            ...
            return strA1 != null ? _deserialize(strA1, deserializationContext) : super.deserialize(jsonParser, deserializationContext);
        }
        ...
        @Override // com.fasterxml.jackson.databind.deser.std.FromStringDeserializer, com.fasterxml.jackson.databind.deser.std.StdScalarDeserializer, defpackage.s51
    ...
    protected Object _deserializeFromOther(JsonParser jsonParser, DeserializationContext deserializationContext, JsonToken jsonToken) throws IOException {
        ...
        return this._valueClass.isAssignableFrom(objH0.getClass()) ? objH0 : _deserializeEmbedded(objH0, deserializationContext);
    }
    ...
    public T deserialize(JsonParser jsonParser, DeserializationContext deserializationContext) throws IOException {
        ...
        if (strA1 == null) {
            ...
            if (jsonTokenD != JsonToken.START_OBJECT) {
                return (T) _deserializeFromOther(jsonParser, deserializationContext, jsonTokenD);
            }
            strA1 = deserializationContext.extractScalarFromObject(jsonParser, this, this._valueClass);
        }
        if (strA1.isEmpty()) {
        ...
        if (_shouldTrim()) {
            ...
            if (strTrim != strA1 && strTrim.isEmpty()) {
                return (T) _deserializeFromEmptyString(deserializationContext);
            }
            strA1 = strTrim;
        }
        try {
            return _deserialize(strA1, deserializationContext);
            ...
            throw deserializationContext.weirdStringException(strA1, this._valueClass, str).withCause(e);
        }
    }
