...
@e41
public class StdKeyDeserializer extends a91 implements Serializable {
    ...
    static final class DelegatingKD extends a91 implements Serializable {
        private static final long serialVersionUID = 1;
        protected final s51 _delegate;
        protected final Class<?> _keyClass;

        protected DelegatingKD(Class<?> cls, s51 s51Var) {
            this._keyClass = cls;
            this._delegate = s51Var;
        }
        ...
        public final Object deserializeKey(String str, DeserializationContext deserializationContext) throws IOException {
            ...
            q33 q33VarBufferForInputBuffering = deserializationContext.bufferForInputBuffering();
            q33VarBufferForInputBuffering.w1(str);
            try {
                JsonParser jsonParserN1 = q33VarBufferForInputBuffering.N1();
                jsonParserN1.n1();
                Object objDeserialize = this._delegate.deserialize(jsonParserN1, deserializationContext);
    ...
    static final class StringKD extends StdKeyDeserializer {
        ...
        @Override // com.fasterxml.jackson.databind.deser.std.StdKeyDeserializer, defpackage.a91
    ...
    protected Object _parse(String str, DeserializationContext deserializationContext) throws Exception {
        switch (this._kind) {
            case 1:
                ...
                return "false".equals(str) ? Boolean.FALSE : deserializationContext.handleWeirdKey(this._keyClass, str, "value not 'true' or 'false'", new Object[0]);
            case 2:
    ...
    protected Object _weirdKey(DeserializationContext deserializationContext, String str, Exception exc) throws IOException {
        return deserializationContext.handleWeirdKey(this._keyClass, str, "problem: %s", ay.o(exc));
    }
    ...
    public Object deserializeKey(String str, DeserializationContext deserializationContext) throws IOException {
        ...
        try {
            ...
            if (ay.L(this._keyClass) && deserializationContext.getConfig().isEnabled(DeserializationFeature.READ_UNKNOWN_ENUM_VALUES_AS_NULL)) {
                return null;
            }
            return deserializationContext.handleWeirdKey(this._keyClass, str, "not a valid representation", new Object[0]);
        } catch (Exception e) {
            return deserializationContext.handleWeirdKey(this._keyClass, str, "not a valid representation, problem: (%s) %s", e.getClass().getName(), ay.o(e));
        }
    }
