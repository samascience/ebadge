...
public class BeanPropertyMap implements Iterable<SettableBeanProperty>, Serializable {
    ...
    protected SettableBeanProperty _rename(SettableBeanProperty settableBeanProperty, NameTransformer nameTransformer) {
        ...
        return (valueDeserializer == null || (s51VarUnwrappingDeserializer = valueDeserializer.unwrappingDeserializer(nameTransformer)) == valueDeserializer) ? settableBeanPropertyWithSimpleName : settableBeanPropertyWithSimpleName.withValueDeserializer(s51VarUnwrappingDeserializer);
    }
