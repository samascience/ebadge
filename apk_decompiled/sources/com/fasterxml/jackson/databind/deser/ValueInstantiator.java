...
public abstract class ValueInstantiator {
    ...
    public static class Delegating extends ValueInstantiator implements Serializable {
        ...
        @Override // com.fasterxml.jackson.databind.deser.ValueInstantiator
        public ValueInstantiator createContextual(DeserializationContext deserializationContext, kh khVar) throws JsonMappingException {
            ValueInstantiator valueInstantiatorCreateContextual = this._delegate.createContextual(deserializationContext, khVar);
        ...
        @Override // com.fasterxml.jackson.databind.deser.ValueInstantiator
        public Object createFromObjectWith(DeserializationContext deserializationContext, SettableBeanProperty[] settableBeanPropertyArr, b bVar) throws IOException {
            return delegate().createFromObjectWith(deserializationContext, settableBeanPropertyArr, bVar);
        }
    }
    ...
    public Object createFromObjectWith(DeserializationContext deserializationContext, SettableBeanProperty[] settableBeanPropertyArr, b bVar) throws IOException {
        return createFromObjectWith(deserializationContext, bVar.g(settableBeanPropertyArr));
    }
}
