...
public abstract class TypeBase extends JavaType implements a {
    ...
    public void serializeWithType(JsonGenerator jsonGenerator, an2 an2Var, z63 z63Var) throws IOException {
        ...
        z63Var.g(jsonGenerator, writableTypeId);
        serialize(jsonGenerator, an2Var);
        z63Var.h(jsonGenerator, writableTypeId);
    }
    ...
    @Override // com.fasterxml.jackson.databind.JavaType
    /* JADX INFO: renamed from: containedType */
    public JavaType mo14containedType(int i) {
