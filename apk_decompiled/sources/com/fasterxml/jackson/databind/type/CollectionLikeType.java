...
public class CollectionLikeType extends TypeBase {
    ...
    public JavaType withHandlersFrom(JavaType javaType) {
        ...
        return (javaTypeMo15getContentType == null || (javaTypeWithHandlersFrom = this._elementType.withHandlersFrom(javaTypeMo15getContentType)) == this._elementType) ? javaTypeWithHandlersFrom2 : javaTypeWithHandlersFrom2.withContentType(javaTypeWithHandlersFrom);
    }
    ...
    @Override // com.fasterxml.jackson.databind.JavaType
    /* JADX INFO: renamed from: getContentType */
