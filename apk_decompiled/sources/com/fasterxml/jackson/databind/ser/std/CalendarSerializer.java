...
public class CalendarSerializer extends DateTimeSerializerBase<Calendar> {
    ...
    public void serialize(Calendar calendar, JsonGenerator jsonGenerator, an2 an2Var) throws IOException {
        if (_asTimestamp(an2Var)) {
            jsonGenerator.a1(_timestamp(calendar));
        } else {
            _serializeAsString(calendar.getTime(), jsonGenerator, an2Var);
        }
    }
