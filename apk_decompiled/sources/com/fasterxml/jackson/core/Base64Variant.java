...
public final class Base64Variant implements Serializable {
    ...
    protected Object readResolve() {
        Base64Variant base64VariantB = a.b(this._name);
        boolean z = this._writePadding;
        boolean z2 = base64VariantB._writePadding;
        return (z == z2 && this._paddingChar == base64VariantB._paddingChar && this._paddingReadBehaviour == base64VariantB._paddingReadBehaviour && this._maxLineLength == base64VariantB._maxLineLength && z == z2) ? base64VariantB : new Base64Variant(base64VariantB, this._name, z, this._paddingChar, this._paddingReadBehaviour, this._maxLineLength);
    }
    ...
    public String encode(byte[] bArr, boolean z) {
        ...
        if (i5 > 0) {
            int i6 = i2 + 1;
            int i7 = bArr[i2] << AttrAndFunCode.SYS_INFO_ATTR_FIXED_LEN_DATA_FUN;
            if (i5 == 2) {
                i7 |= (bArr[i6] & 255) << 8;
            }
    ...
    public void decode(String str, zo zoVar) throws IllegalArgumentException {
            ...
            if (cCharAt > ' ') {
                ...
                if (iDecodeBase64Char3 < 0) {
                    ...
                    if (iDecodeBase64Char4 < 0) {
                        ...
                        zoVar.w((i6 << 6) | iDecodeBase64Char4);
                    }
                }
            } else {
                i = i2;
