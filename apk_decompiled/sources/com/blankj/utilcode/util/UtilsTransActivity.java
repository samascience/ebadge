...
public class UtilsTransActivity extends AppCompatActivity {
    ...
    protected static void G(Activity activity, o.b bVar, TransActivityDelegate transActivityDelegate, Class cls) {
        if (transActivityDelegate == null) {
            return;
        }
        Intent intent = new Intent(o.a(), (Class<?>) cls);
    ...
    public static void H(o.b bVar, TransActivityDelegate transActivityDelegate) {
        G(null, bVar, transActivityDelegate, UtilsTransActivity.class);
    }
