...
public class JniInterface {
    ...
    public static void loadSo() {
        ...
        try {
            ...
            if (contextA != null) {
                if (new File(contextA.getFilesDir().toString() + WatchConstant.FAT_FS_ROOT + AuthAgent.SECURE_LIB_NAME).exists()) {
                    System.load(contextA.getFilesDir().toString() + WatchConstant.FAT_FS_ROOT + AuthAgent.SECURE_LIB_NAME);
                    isJniOk = true;
