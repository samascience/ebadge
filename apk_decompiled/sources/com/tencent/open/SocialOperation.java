...
public class SocialOperation extends BaseApi {
    ...
    public void bindQQGroup(final Activity activity, String str, String str2, final IUiListener iUiListener) {
        ...
        if (TextUtils.isEmpty(strA)) {
            ...
            if (iUiListener != null) {
                iUiListener.onError(new UiError(1005, "appName params is null", Constants.STR_EMPTY));
                return;
            }
            return;
        }
        if (TextUtils.isEmpty(str)) {
            ...
            if (iUiListener != null) {
                iUiListener.onError(new UiError(1006, "organizationId params is null", Constants.STR_EMPTY));
                return;
            }
            return;
        }
        if (TextUtils.isEmpty(str2)) {
            ...
            if (iUiListener != null) {
                iUiListener.onError(new UiError(1007, "organizationName params is null", Constants.STR_EMPTY));
                return;
            }
            return;
        }
        stringBuffer.append("&app_name=" + Base64.encodeToString(l.j(strA), 2));
        ...
        stringBuffer.append("&app_name_url_encode=" + l.f(Base64.encodeToString(l.j(strA), 2)));
    ...
    public void a(Activity activity) {
        a(activity, Constants.STR_EMPTY);
    }

    private void a(Activity activity, String str) {
        new TDialog(activity, Constants.STR_EMPTY, a(str), null, this.c).show();
    }
}
