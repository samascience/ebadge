...
public class c {
    ...
    private Runnable g = new Runnable() { // from class: com.tencent.open.utils.c.2
        ...
        public void run() throws Throwable {
            ...
            String str = "share_qq_" + l.g(c.this.a) + ".jpg";
            String str2 = c.c + str;
    ...
    public void a(String str, d dVar) {
        ...
        if (str != null && !str.equals(Constants.STR_EMPTY)) {
            ...
            if (this.f.get() != null) {
                ...
                File fileH = l.h(activity, "Images");
                ...
                if (fileH == null) {
                    ...
                    sb.append(j.d(activity) ? fileH.getAbsolutePath() : externalStorageDirectory.getAbsolutePath());
                    sb.append("/tmp/");
                    c = sb.toString();
                }
            }
