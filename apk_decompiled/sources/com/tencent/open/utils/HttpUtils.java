...
public class HttpUtils {
    ...
    /* JADX WARN: Code duplicated, block: B:52:0x018a A[LOOP:0: B:12:0x00c0->B:52:0x018a, LOOP_END] */
    /* JADX WARN: Code duplicated, block: B:67:0x018f A[SYNTHETIC] */
    /* JADX WARN: Code duplicated, block: B:68:0x0110 A[EDGE_INSN: B:68:0x0110->B:28:0x0110 BREAK  A[LOOP:0: B:12:0x00c0->B:52:0x018a], SYNTHETIC] */
    public static JSONObject request(QQToken qQToken, Context context, String str, Bundle bundle, String str2) throws JSONException, IOException, HttpStatusException, NetworkUnavailableException {
        ...
        int iA = h.a(context, qQToken.getAppId()).a("Common_HttpRetryCount");
        SLog.v("OpenConfig_test", "config 1:Common_HttpRetryCount            config_value:" + iA + "   appid:" + qQToken.getAppId() + "     url:" + str4);
        if (iA == 0) {
            iA = 3;
        }
        int i3 = iA;
        SLog.v("OpenConfig_test", "config 1:Common_HttpRetryCount            result_value:" + i3 + "   appid:" + qQToken.getAppId() + "     url:" + str4);
        int i4 = 0;
        ...
        while (true) {
            ...
            try {
                try {
                    try {
                        com.tencent.open.a.b bVarA = a(str3, str2, bundle);
                        int iD = bVarA.d();
                        SLog.i("openSDK_LOG.HttpUtils", "request statusCode " + iD);
                        if (iD == 200) {
                            JSONObject jSONObjectD = l.d(bVarA.a());
                            try {
                                try {
        ...
        com.tencent.open.b.h.a().a(str4, jElapsedRealtime2, j, jB, i);
        return jSONObject;
    }
