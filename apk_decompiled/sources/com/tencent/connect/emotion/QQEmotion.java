...
public class QQEmotion extends BaseApi {
    ...
    private boolean a(Context context, ArrayList<Uri> arrayList) {
        ...
        for (int i = 0; i < arrayList.size(); i++) {
            long jA = l.a(context, arrayList.get(i));
            if (jA > PlaybackStateCompat.ACTION_SET_CAPTIONING_ENABLED) {
    ...
    public void setEmotions(Activity activity, ArrayList<Uri> arrayList, IUiListener iUiListener) {
        ...
        sb.append(strA2);
        stringBuffer.append("&set_uri_list=" + Base64.encodeToString(l.j(strA2), 2));
        stringBuffer.append("&");
    ...
    private String a(Activity activity, ArrayList<Uri> arrayList) {
        ...
        while (it.hasNext()) {
            Uri uriA = l.a(activity, this.c.getAppId(), l.b(activity, it.next()));
            if (uriA == null) {
