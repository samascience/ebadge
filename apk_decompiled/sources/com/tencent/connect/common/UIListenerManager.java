...
public class UIListenerManager {
    ...
    public void handleDataToListener(Intent intent, IUiListener iUiListener) {
        ...
        if ("action_login".equals(stringExtra)) {
            ...
            if (intExtra != 0) {
                SLog.e("openSDK_LOG.UIListenerManager", "OpenUi, onActivityResult, onError = " + intExtra + Constants.STR_EMPTY);
        ...
        if ("action_share".equals(stringExtra)) {
            ...
            if ("error".equals(stringExtra3)) {
                iUiListener.onError(new UiError(-6, "unknown error", stringExtra4 + Constants.STR_EMPTY));
                return;
            }
            if ("complete".equals(stringExtra3)) {
                try {
                    ...
                    e2.printStackTrace();
                    iUiListener.onError(new UiError(-4, "json error", stringExtra4 + Constants.STR_EMPTY));
                }
            }
        }
    }
        ...
        if (i2 != -1) {
            ...
            if ("action_login".equals(stringExtra)) {
                ...
                if ("cancel".equals(stringExtra3)) {
                    ...
                    listnerWithRequestCode.onError(new UiError(-6, "unknown error", stringExtra4 + Constants.STR_EMPTY));
                    ...
                    try {
                        ...
                        listnerWithRequestCode.onError(new UiError(-4, "json error", stringExtra4 + Constants.STR_EMPTY));
                    }
                }
            } else {
