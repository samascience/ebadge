...
public class QzoneShare extends BaseApi {
    ...
    /* JADX WARN: Code duplicated, block: B:55:0x01f4  */
    /* JADX WARN: Code duplicated, block: B:58:0x0216  */
    /* JADX WARN: Code duplicated, block: B:61:0x0258  */
    /* JADX WARN: Code duplicated, block: B:64:0x027e  */
    /* JADX WARN: Code duplicated, block: B:67:0x02a4  */
    /* JADX WARN: Code duplicated, block: B:70:0x02ca  */
    /* JADX WARN: Code duplicated, block: B:73:0x02ec  */
    /* JADX WARN: Code duplicated, block: B:76:0x0374  */
    /* JADX WARN: Code duplicated, block: B:78:0x037a  */
    /* JADX WARN: Code duplicated, block: B:80:0x038c  */
    /* JADX WARN: Code duplicated, block: B:82:0x039d  */
    /* JADX WARN: Code duplicated, block: B:85:0x03a8  */
    /* JADX WARN: Code duplicated, block: B:88:0x03b5  */
    /* JADX WARN: Code duplicated, block: B:89:0x03fd  */
    /* JADX WARN: Instruction removed from duplicated block: B:37:0x012c, please report this as an issue */
    /* JADX WARN: Instruction removed from duplicated block: B:40:0x0152, please report this as an issue */
    /* JADX WARN: Instruction removed from duplicated block: B:43:0x0174, please report this as an issue */
    /* JADX WARN: Instruction removed from duplicated block: B:46:0x0196, please report this as an issue */
    /* JADX WARN: Instruction removed from duplicated block: B:49:0x01b0, please report this as an issue */
    /* JADX WARN: Instruction removed from duplicated block: B:52:0x01d2, please report this as an issue */
    /* JADX WARN: Instruction removed from duplicated block: B:55:0x01f4, please report this as an issue */
    /* JADX WARN: Instruction removed from duplicated block: B:58:0x0216, please report this as an issue */
    /* JADX WARN: Instruction removed from duplicated block: B:61:0x0258, please report this as an issue */
    /* JADX WARN: Instruction removed from duplicated block: B:64:0x027e, please report this as an issue */
    /* JADX WARN: Instruction removed from duplicated block: B:67:0x02a4, please report this as an issue */
    /* JADX WARN: Instruction removed from duplicated block: B:70:0x02ca, please report this as an issue */
    /* JADX WARN: Instruction removed from duplicated block: B:73:0x02ec, please report this as an issue */
    private void b(Activity activity, Bundle bundle, IUiListener iUiListener) {
        ...
        String string10 = Constants.STR_EMPTY;
        try {
                        ...
                        try {
                            ...
                            try {
                                ...
                                if (stringArrayList != null) {
                                    ...
                                    stringBuffer.append("&image_url=" + Base64.encodeToString(l.j(URLEncoder.encode(str3)), 2));
                                    if (!l.h(str3)) {
                                        strA = l.a(appId, activity, str3, iUiListener);
                                        if (!TextUtils.isEmpty(strA)) {
                                            stringBuffer.append("&image_uri=" + Base64.encodeToString(l.j(URLEncoder.encode(strA)), 2));
                                        }
                                    }
                                }
                                if (!TextUtils.isEmpty(string)) {
                                    stringBuffer.append("&title=" + Base64.encodeToString(l.j(string), 2));
                                }
                                ...
                                if (!TextUtils.isEmpty(string3)) {
                                    stringBuffer.append("&url=" + Base64.encodeToString(l.j(string3), 2));
                                }
                                if (!TextUtils.isEmpty(string5)) {
                                    stringBuffer.append("&app_name=" + Base64.encodeToString(l.j(string5), 2));
                                }
                                if (!l.e(openIdWithCache)) {
                                    stringBuffer.append("&open_id=" + Base64.encodeToString(l.j(openIdWithCache), 2));
                                }
                                if (!l.e(string4)) {
                                    stringBuffer.append("&audioUrl=" + Base64.encodeToString(l.j(string4), 2));
                                }
                                stringBuffer.append("&req_type=" + Base64.encodeToString(l.j(String.valueOf(i)), 2));
                                if (!TextUtils.isEmpty(str)) {
                                    stringBuffer.append("&mini_program_appid=" + Base64.encodeToString(l.j(String.valueOf(str)), 2));
                                }
                                if (!TextUtils.isEmpty(string7)) {
                                    stringBuffer.append("&mini_program_path=" + Base64.encodeToString(l.j(String.valueOf(string7)), 2));
                                }
                                if (!TextUtils.isEmpty(string8)) {
                                    stringBuffer.append("&mini_program_type=" + Base64.encodeToString(l.j(String.valueOf(string8)), 2));
                                }
                                if (!l.e(str2)) {
                                    stringBuffer.append("&share_qq_ext_str=" + Base64.encodeToString(l.j(str2), 2));
                                }
                                if (!TextUtils.isEmpty(string10)) {
                                    stringBuffer.append("&share_qzone_ext_str=" + Base64.encodeToString(l.j(string10), 2));
                                }
                                stringBuffer.append("&cflag=" + Base64.encodeToString(l.j(String.valueOf(i3)), 2));
                                ...
                                if (a(intent)) {
                                    e.a().a(this.c.getOpenId(), this.c.getAppId(), Constants.VIA_SHARE_TO_QZONE, Constants.VIA_REPORT_TYPE_SHARE_TO_QZONE, "3", "0", this.mViaShareQzoneType, "0", "1", "0");
                                    e.a().a(0, "SHARE_CHECK_SDK", Constants.DEFAULT_UIN, this.c.getAppId(), String.valueOf(4), Long.valueOf(SystemClock.elapsedRealtime()), 0, 1, Constants.STR_EMPTY);
                                } else {
                                    e.a().a(this.c.getOpenId(), this.c.getAppId(), Constants.VIA_SHARE_TO_QZONE, Constants.VIA_REPORT_TYPE_SHARE_TO_QZONE, "3", "1", this.mViaShareQzoneType, "0", "1", "0");
    ...
    /* JADX WARN: Code duplicated, block: B:113:0x039b  */
    /* JADX WARN: Code duplicated, block: B:114:0x03a5  */
    /* JADX WARN: Code duplicated, block: B:133:0x0424  */
    /* JADX WARN: Code duplicated, block: B:24:0x00d6 A[DONT_INVERT] */
    ...
    /* JADX WARN: Code duplicated, block: B:64:0x0220  */
    /* JADX WARN: Code duplicated, block: B:68:0x025d  */
    /* JADX WARN: Code duplicated, block: B:69:0x026a  */
    ...
    public void shareToQzone(Activity activity, Bundle bundle, IUiListener iUiListener) {
        ...
        if (strA != null) {
            ...
            if (this.d) {
                bundle2 = bundle;
                bundle2.putString("title", Constants.STR_EMPTY);
                bundle2.putString("summary", Constants.STR_EMPTY);
            } else {
                bundle2 = bundle;
                ...
                if (!l.e(string2) && string2.length() > 600) {
                    bundle2.putString("summary", l.a(string2, BannerConfig.SCROLL_TIME, str2, str2));
                }
            }
            if (!TextUtils.isEmpty(strA)) {
