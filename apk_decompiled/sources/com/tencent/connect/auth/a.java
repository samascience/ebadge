...
public class a extends Dialog {
    ...
    private class C0109a extends WebViewClient {
        private C0109a() {
        }
        ...
        public void onPageStarted(WebView webView, String str, Bitmap bitmap) {
            ...
            a.this.f313q = SystemClock.elapsedRealtime();
        ...
        public void onReceivedError(WebView webView, int i, String str, String str2) {
            ...
            long jElapsedRealtime = SystemClock.elapsedRealtime() - a.this.f313q;
        ...
        public boolean shouldOverrideUrlLoading(WebView webView, String str) {
            ...
            if (str.startsWith("auth://browser")) {
                JSONObject jSONObjectC = l.c(str);
                a aVar = a.this;
                aVar.m = aVar.e();
                if (!a.this.m) {
                    if (jSONObjectC.optString("fail_cb", null) != null) {
                        a.this.a(jSONObjectC.optString("fail_cb"), Constants.STR_EMPTY);
    ...
    private void d() {
        ...
        this.j.setWebViewClient(new C0109a());
