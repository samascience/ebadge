...
public class RangeSlider extends BaseSlider {
    ...
    @Override // com.google.android.material.slider.BaseSlider
    public /* bridge */ /* synthetic */ void setLabelFormatter(ca1 ca1Var) {
        super.setLabelFormatter(ca1Var);
    }
    ...
    public RangeSlider(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray typedArrayI = o23.i(context, attributeSet, R$styleable.RangeSlider, i, BaseSlider.B0, new int[0]);
        int i2 = R$styleable.RangeSlider_values;
        if (typedArrayI.hasValue(i2)) {
            setValues(G0(typedArrayI.getResources().obtainTypedArray(typedArrayI.getResourceId(i2, 0))));
        }
        this.G0 = typedArrayI.getDimension(R$styleable.RangeSlider_minSeparation, 0.0f);
        typedArrayI.recycle();
    }
}
