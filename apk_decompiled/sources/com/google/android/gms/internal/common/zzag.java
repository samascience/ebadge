...
public abstract class zzag extends zzac implements List, RandomAccess {
    private static final lt3 zza = new d(zzai.zza, 0);
    ...
    public final boolean equals(@CheckForNull Object obj) {
        ...
        if (obj instanceof List) {
            ...
            if (size == list.size()) {
                ...
                while (it.hasNext()) {
                    if (it2.hasNext() && zu3.a(it.next(), it2.next())) {
                    }
                }
                if (!it2.hasNext()) {
                    return true;
    ...
    public final lt3 listIterator(int i) {
        dv3.b(i, size(), "index");
        return isEmpty() ? zza : new d(this, i);
    }
}
