...
public abstract class yf {
    ...
    public static String c(byte[] bArr, String str) {
        ...
        for (int i3 = 0; i3 < length2; i3 += 3) {
            ...
            int i5 = i3 + 2;
            bArr2[i + 2] = bArr3[((bArr[i4] & AttrAndFunCode.SYS_INFO_ATTR_PHONE_STATUS) << 2) | ((bArr[i5] & 255) >> 6)];
            int i6 = i + 4;
            bArr2[i + 3] = bArr3[bArr[i5] & 63];
            if ((i6 - i2) % 76 != 0 || i6 == 0) {
                i = i6;
            } else {
                i += 5;
        ...
        if (length3 == 1) {
            ...
            int i10 = i + 3;
            bArr2[i + 2] = bArr5[(bArr[i9] & AttrAndFunCode.SYS_INFO_ATTR_PHONE_STATUS) << 2];
            i += 4;
            bArr2[i10] = 61;
        }
