    ...
    public static class b {
        ...
        private static void g(Path path, float f, float f2, float f3, float f4, float f5, float f6, float f7, boolean z, boolean z2) {
            ...
            if (d19 < 0.0d) {
                ...
                g(path, f, f2, f3, f4, f5 * fSqrt, f6 * fSqrt, f7, z, z2);
                return;
            }
            ...
            double d22 = d * d6;
            double d23 = d2 * d9;
            f(path, (d22 * dCos) - (d23 * dSin), (d22 * dSin) + (d23 * dCos), d6, d9, d3, d5, radians, dAtan2, dAtan3);
        }
        ...
        b(b bVar) {
            this.a = bVar.a;
            float[] fArr = bVar.b;
            this.b = oz1.c(fArr, 0, fArr.length);
        }
    }
}
