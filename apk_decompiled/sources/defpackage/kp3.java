...
public class kp3 {
    ...
    class b {
        ...
        double a(a aVar) {
            ...
            double d = aVar2.a;
            a aVar3 = this.a;
            a aVar4 = kp3Var.new a(d - aVar3.a, aVar2.b - aVar3.b);
            kp3 kp3Var2 = kp3.this;
            double d2 = aVar.a;
            a aVar5 = this.a;
            a aVar6 = kp3Var2.new a(d2 - aVar5.a, aVar.b - aVar5.b);
            return (aVar4.a * aVar6.b) - (aVar4.b * aVar6.a);
        }

        boolean b(a aVar) {
            return kp3.this.a(a(aVar)) == 0 && aVar.a < Math.max(this.a.a, this.b.a) + 1.0E-8d && aVar.a > Math.min(this.a.a, this.b.a) - 1.0E-8d && aVar.b < Math.max(this.a.b, this.b.b) + 1.0E-8d && aVar.b > Math.min(this.a.b, this.b.b) - 1.0E-8d;
        }
    }
    ...
    private kp3() {
        ...
        while (i < length - 1) {
            ...
            double[] dArr = c;
            double d2 = dArr[i] * 100000.0d;
            double[] dArr2 = d;
            a aVar = new a(d2, dArr2[i] * 100000.0d);
            i++;
