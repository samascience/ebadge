...
public class bw2 {
    ...
    public void b(DeserializationContext deserializationContext, JavaType javaType, kh khVar) throws JsonMappingException {
        ...
        deserializationContext.reportBadTypeDefinition(khVar, "Illegal type (%s) to deserialize: prevented for security reasons", name);
    }
}
