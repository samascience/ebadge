...
public abstract class c73 {
    ...
    public static ColorStateList g(TypedArray typedArray, XmlPullParser xmlPullParser, Resources.Theme theme, String str, int i) {
        ...
        if (i2 != 2) {
            return (i2 < 28 || i2 > 31) ? mz.d(typedArray.getResources(), typedArray.getResourceId(i, 0), theme) : h(typedValue);
        }
    ...
    public static w00 i(TypedArray typedArray, XmlPullParser xmlPullParser, Resources.Theme theme, String str, int i, int i2) {
        if (p(xmlPullParser, str)) {
            TypedValue typedValue = new TypedValue();
            typedArray.getValue(i, typedValue);
            int i3 = typedValue.type;
            if (i3 >= 28 && i3 <= 31) {
                return w00.b(typedValue.data);
            }
            w00 w00VarG = w00.g(typedArray.getResources(), typedArray.getResourceId(i, 0), theme);
            if (w00VarG != null) {
                return w00VarG;
            }
        }
