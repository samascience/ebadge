...
public final class MediaMetadataCompat implements Parcelable {
    ...
    static final u9 METADATA_KEYS_TYPE;
    ...
    static {
        u9 u9Var = new u9();
        METADATA_KEYS_TYPE = u9Var;
        u9Var.put(METADATA_KEY_TITLE, 1);
        u9Var.put(METADATA_KEY_ARTIST, 1);
        u9Var.put(METADATA_KEY_DURATION, 0);
        u9Var.put(METADATA_KEY_ALBUM, 1);
        u9Var.put(METADATA_KEY_AUTHOR, 1);
        u9Var.put(METADATA_KEY_WRITER, 1);
        u9Var.put(METADATA_KEY_COMPOSER, 1);
        u9Var.put(METADATA_KEY_COMPILATION, 1);
        u9Var.put(METADATA_KEY_DATE, 1);
        u9Var.put(METADATA_KEY_YEAR, 0);
        u9Var.put(METADATA_KEY_GENRE, 1);
        u9Var.put(METADATA_KEY_TRACK_NUMBER, 0);
        u9Var.put(METADATA_KEY_NUM_TRACKS, 0);
        u9Var.put(METADATA_KEY_DISC_NUMBER, 0);
        u9Var.put(METADATA_KEY_ALBUM_ARTIST, 1);
        u9Var.put(METADATA_KEY_ART, 2);
        u9Var.put(METADATA_KEY_ART_URI, 1);
        u9Var.put(METADATA_KEY_ALBUM_ART, 2);
        u9Var.put(METADATA_KEY_ALBUM_ART_URI, 1);
        u9Var.put(METADATA_KEY_USER_RATING, 3);
        u9Var.put(METADATA_KEY_RATING, 3);
        u9Var.put(METADATA_KEY_DISPLAY_TITLE, 1);
        u9Var.put(METADATA_KEY_DISPLAY_SUBTITLE, 1);
        u9Var.put(METADATA_KEY_DISPLAY_DESCRIPTION, 1);
        u9Var.put(METADATA_KEY_DISPLAY_ICON, 2);
        u9Var.put(METADATA_KEY_DISPLAY_ICON_URI, 1);
        u9Var.put(METADATA_KEY_MEDIA_ID, 1);
        u9Var.put(METADATA_KEY_BT_FOLDER_TYPE, 0);
        u9Var.put(METADATA_KEY_MEDIA_URI, 1);
        u9Var.put(METADATA_KEY_ADVERTISEMENT, 0);
        u9Var.put(METADATA_KEY_DOWNLOAD_STATUS, 0);
    ...
    public static final class Builder {
        ...
        public Builder putBitmap(String str, Bitmap bitmap) {
            u9 u9Var = MediaMetadataCompat.METADATA_KEYS_TYPE;
            if (!u9Var.containsKey(str) || ((Integer) u9Var.get(str)).intValue() == 2) {
        ...
        public Builder putLong(String str, long j) {
            u9 u9Var = MediaMetadataCompat.METADATA_KEYS_TYPE;
            if (!u9Var.containsKey(str) || ((Integer) u9Var.get(str)).intValue() == 0) {
        ...
        public Builder putRating(String str, RatingCompat ratingCompat) {
            u9 u9Var = MediaMetadataCompat.METADATA_KEYS_TYPE;
            if (!u9Var.containsKey(str) || ((Integer) u9Var.get(str)).intValue() == 3) {
        ...
        public Builder putString(String str, String str2) {
            u9 u9Var = MediaMetadataCompat.METADATA_KEYS_TYPE;
            if (!u9Var.containsKey(str) || ((Integer) u9Var.get(str)).intValue() == 1) {
