...
public class MediaSessionCompat {
    ...
    public static abstract class Callback {
        ...
        private class CallbackHandler extends Handler {
            ...
            public void handleMessage(Message message) {
                if (message.what == 1) {
                    Callback.this.handleMediaPlayPauseKeySingleTapIfPending((th1) message.obj);
                }
            }
        }
                ...
                try {
                    ...
                    if (str.equals(MediaControllerCompat.COMMAND_GET_EXTRA_BINDER)) {
                        ...
                        if (mediaSessionImplApi21 != null) {
                            ...
                            vo.b(bundle2, MediaSessionCompat.KEY_EXTRA_BINDER, iBinderAsBinder);
        ...
        void handleMediaPlayPauseKeySingleTapIfPending(th1 th1Var) {
            if (this.mMediaPlayPauseKeyPending) {
                ...
                mediaSessionImpl.setCurrentControllerInfo(th1Var);
                if (z && z3) {
                    onPause();
                } else if (!z && z2) {
                    onPlay();
        ...
        public boolean onMediaButtonEvent(Intent intent) {
            ...
            th1 currentControllerInfo = mediaSessionImpl.getCurrentControllerInfo();
    ...
    interface MediaSessionImpl {
        ...
        void setCurrentControllerInfo(th1 th1Var);
        ...
        void setPlaybackToRemote(kg3 kg3Var);
    ...
    static class MediaSessionImplApi28 extends MediaSessionImplApi21 {
        ...
        public final th1 getCurrentControllerInfo() {
            return new th1(((MediaSession) this.mSessionObj).getCurrentControllerInfo());
        }

        @Override // android.support.v4.media.session.MediaSessionCompat.MediaSessionImplApi21, android.support.v4.media.session.MediaSessionCompat.MediaSessionImpl
        public void setCurrentControllerInfo(th1 th1Var) {
        }
    ...
    static class MediaSessionImplBase implements MediaSessionImpl {
        ...
        private kg3.a mVolumeCallback = new kg3.a() { // from class: android.support.v4.media.session.MediaSessionCompat.MediaSessionImplBase.1
            public void onVolumeChanged(kg3 kg3Var) {
        ...
        class MediaSessionStub extends IMediaSession.Stub {
            ...
            public void registerCallbackListener(IMediaControllerCallback iMediaControllerCallback) {
                if (MediaSessionImplBase.this.mDestroyed) {
                    ...
                    MediaSessionImplBase.this.mControllerCallbacks.register(iMediaControllerCallback, new th1("android.media.session.MediaController", Binder.getCallingPid(), Binder.getCallingUid()));
                }
            }
        ...
        class MessageHandler extends Handler {
            ...
            public void handleMessage(Message message) {
                ...
                MediaSessionImplBase.this.setCurrentControllerInfo(new th1(data.getString(MediaSessionCompat.DATA_CALLING_PACKAGE), data.getInt(MediaSessionCompat.DATA_CALLING_PID), data.getInt(MediaSessionCompat.DATA_CALLING_UID)));
        ...
        @Override // android.support.v4.media.session.MediaSessionCompat.MediaSessionImpl
        public th1 getCurrentControllerInfo() {
            th1 th1Var;
            synchronized (this.mLock) {
                th1Var = this.mRemoteUserInfo;
            }
            return th1Var;
        }
        ...
        @Override // android.support.v4.media.session.MediaSessionCompat.MediaSessionImpl
        public void setPlaybackToRemote(kg3 kg3Var) {
    ...
    public static final class Token implements Parcelable {
        ...
        public static Token fromBundle(Bundle bundle) {
            ...
            IMediaSession iMediaSessionAsInterface = IMediaSession.Stub.asInterface(vo.a(bundle, MediaSessionCompat.KEY_EXTRA_BINDER));
        ...
        public Bundle toBundle() {
            ...
            if (iMediaSession != null) {
                vo.b(bundle, MediaSessionCompat.KEY_EXTRA_BINDER, iMediaSession.asBinder());
            }
    ...
    static class MediaSessionImplApi21 implements MediaSessionImpl {
        ...
        class ExtraSession extends IMediaSession.Stub {
            ...
            public void registerCallbackListener(IMediaControllerCallback iMediaControllerCallback) {
                ...
                MediaSessionImplApi21.this.mExtraControllerCallbacks.register(iMediaControllerCallback, new th1(callingPackage, Binder.getCallingPid(), Binder.getCallingUid()));
            }
