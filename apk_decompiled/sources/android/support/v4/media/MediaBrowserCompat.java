...
public final class MediaBrowserCompat {
    ...
    static class MediaBrowserImplApi21 implements MediaBrowserImpl, MediaBrowserServiceCallbackImpl, ConnectionCallback.ConnectionCallbackInternal {
        ...
        private final u9 mSubscriptions = new u9();
        ...
        public void onConnected() {
            ...
            IBinder iBinderA = vo.a(extras, "extra_messenger");
            if (iBinderA != null) {
            ...
            IMediaSession iMediaSessionAsInterface = IMediaSession.Stub.asInterface(vo.a(extras, "extra_session_binder"));
    ...
    private static class ServiceBinderWrapper {
        ...
        void addSubscription(String str, IBinder iBinder, Bundle bundle, Messenger messenger) throws RemoteException {
            ...
            vo.b(bundle2, "data_callback_token", iBinder);
        ...
        void removeSubscription(String str, IBinder iBinder, Messenger messenger) throws RemoteException {
            Bundle bundle = new Bundle();
            bundle.putString("data_media_item_id", str);
            vo.b(bundle, "data_callback_token", iBinder);
    ...
    private static class Subscription {
        ...
        public SubscriptionCallback getCallback(Bundle bundle) {
            for (int i = 0; i < this.mOptionsList.size(); i++) {
                if (nh1.a(this.mOptionsList.get(i), bundle)) {
