...
public class GifAnimationMetaData implements Serializable, Parcelable {
    ...
    public long getDrawableAllocationByteCount(b bVar, int i) {
        if (i >= 1 && i <= 65535) {
            int i2 = i * i;
            return (this.mPixelsBytesCount / ((long) i2)) + ((long) ((bVar == null || bVar.f.isRecycled()) ? ((this.mWidth * this.mHeight) * 4) / i2 : bVar.f.getAllocationByteCount()));
        }
