...
public abstract class a {
    ...
    public static final byte[] a(String str) {
        ...
        p31.e(bArrCopyOf, "copyOf(this, newSize)");
        return bArrCopyOf;
    }
    ...
    public static final String b(byte[] bArr, byte[] bArr2) {
        ...
        while (i < length) {
            ...
            int i4 = i2 + 3;
            bArr3[i2 + 2] = bArr2[((b3 & AttrAndFunCode.SYS_INFO_ATTR_PHONE_STATUS) << 2) | ((b4 & 255) >> 6)];
            i2 += 4;
        ...
        if (length2 == 1) {
            ...
            bArr3[i2 + 2] = bArr2[(b7 & AttrAndFunCode.SYS_INFO_ATTR_PHONE_STATUS) << 2];
            bArr3[i2 + 3] = 61;
        }
        return um3.c(bArr3);
    }
