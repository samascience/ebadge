...
/* JADX INFO: loaded from: com.legend.smartwatch.electronicbadge.android.apk:org/objectweb/asm/Type.SCL.lombok */
public final class Type {
    ...
    public String getClassName() {
        switch (this.sort) {
            ...
            case 10:
            case 12:
                return this.valueBuffer.substring(this.valueBegin, this.valueEnd).replace(JsonPointer.SEPARATOR, '.');
            case 11:
            default:
                throw new AssertionError();
        }
    ...
    public static String getInternalName(Class<?> clazz) {
        return clazz.getName().replace('.', JsonPointer.SEPARATOR);
    }
