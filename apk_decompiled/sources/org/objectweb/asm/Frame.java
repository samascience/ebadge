...
/* JADX INFO: loaded from: com.legend.smartwatch.electronicbadge.android.apk:org/objectweb/asm/Frame.SCL.lombok */
class Frame {
    ...
    static int getAbstractTypeFromApiFormat(SymbolTable symbolTable, Object type) {
        ...
        return UNINITIALIZED_KIND | symbolTable.addUninitializedType(com.tencent.connect.common.Constants.STR_EMPTY, ((Label) type).bytecodeOffset);
    }
    ...
    private int getConcreteOutputType(int abstractOutputType, int numStack) {
        ...
        if (kind == STACK_KIND) {
            int concreteOutputType2 = dim + this.inputStack[numStack - (abstractOutputType & 1048575)];
