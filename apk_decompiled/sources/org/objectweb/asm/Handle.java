...
/* JADX INFO: loaded from: com.legend.smartwatch.electronicbadge.android.apk:org/objectweb/asm/Handle.SCL.lombok */
public final class Handle {
    ...
    public String toString() {
        return this.owner + '.' + this.name + this.descriptor + " (" + this.tag + (this.isInterface ? " itf" : com.tencent.connect.common.Constants.STR_EMPTY) + ')';
    }
}
