...
/* JADX INFO: loaded from: com.legend.smartwatch.electronicbadge.android.apk:org/objectweb/asm/Constants.SCL.lombok */
final class Constants {
    ...
    static void checkAsmExperimental(Object caller) {
        ...
        String internalName = callerClass.getName().replace('.', JsonPointer.SEPARATOR);
