...
public final class FlowKt__TransformKt$mapNotNull$$inlined$unsafeTransform$1<R> implements Flow<R> {
    ...
    final /* synthetic */ or0 $transform$inlined$1;
    ...
    public static final class AnonymousClass2<T> implements FlowCollector {
        ...
        @h70(c = "kotlinx.coroutines.flow.FlowKt__TransformKt$mapNotNull$$inlined$unsafeTransform$1$2", f = "Transform.kt", l = {223, 224}, m = "emit")
        ...
        public final Object emit$$forInline(Object obj, x30 x30Var) {
            ...
            Object objInvoke = this.$transform$inlined.invoke(obj, x30Var);
            if (objInvoke != null) {
                j21.c(0);
                flowCollector.emit(objInvoke, x30Var);
                j21.c(1);
            }
            return k83.a;
        }
    ...
    public FlowKt__TransformKt$mapNotNull$$inlined$unsafeTransform$1(Flow flow, or0 or0Var) {
        this.$this_unsafeTransform$inlined = flow;
        this.$transform$inlined$1 = or0Var;
    }

    @Override // kotlinx.coroutines.flow.Flow
    public Object collect(FlowCollector flowCollector, x30 x30Var) {
        Object objCollect = this.$this_unsafeTransform$inlined.collect(new AnonymousClass2(flowCollector, this.$transform$inlined$1), x30Var);
        return objCollect == a.d() ? objCollect : k83.a;
    }

    public Object collect$$forInline(FlowCollector flowCollector, x30 x30Var) {
        j21.c(4);
        new ContinuationImpl(x30Var) { // from class: kotlinx.coroutines.flow.FlowKt__TransformKt$mapNotNull$$inlined$unsafeTransform$1.1
            int label;
            /* synthetic */ Object result;
