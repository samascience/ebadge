...
public final class FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$10 implements Flow<Long> {
    final /* synthetic */ xd1 $this_asFlow$inlined;
    ...
    @h70(c = "kotlinx.coroutines.flow.FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$10", f = "Builders.kt", l = {116}, m = "collect")
    ...
    public FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$10(xd1 xd1Var) {
    }

    /* JADX WARN: Code duplicated, block: B:7:0x0013  */
    @Override // kotlinx.coroutines.flow.Flow
    public Object collect(FlowCollector<? super Long> flowCollector, x30 x30Var) throws Throwable {
        ...
        Iterator it = (Iterator) anonymousClass1.L$1;
        d.b(obj);
        if (!it.hasNext()) {
            return k83.a;
        }
