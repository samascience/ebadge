...
public final class FlowKt__BuildersKt$flowOf$$inlined$unsafeFlow$1<T> implements Flow<T> {
    ...
    @h70(c = "kotlinx.coroutines.flow.FlowKt__BuildersKt$flowOf$$inlined$unsafeFlow$1", f = "Builders.kt", l = {115}, m = "collect")
    ...
    public java.lang.Object collect(kotlinx.coroutines.flow.FlowCollector<? super T> r8, defpackage.x30 r9) {
        /*
            r7 = this;
        ...
        L62:
            ...
            return r8
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.flow.FlowKt__BuildersKt$flowOf$$inlined$unsafeFlow$1.collect(kotlinx.coroutines.flow.FlowCollector, x30):java.lang.Object");
    }
}
