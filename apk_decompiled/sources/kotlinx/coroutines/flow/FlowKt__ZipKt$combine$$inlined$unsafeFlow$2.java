...
public final class FlowKt__ZipKt$combine$$inlined$unsafeFlow$2<R> implements Flow<R> {
    ...
    public FlowKt__ZipKt$combine$$inlined$unsafeFlow$2(Flow[] flowArr, or0 or0Var) {
    ...
    public Object collect(FlowCollector<? super R> flowCollector, x30 x30Var) {
        ...
        p31.j();
        Object objCombineInternal = CombineKt.combineInternal(flowCollector, flowArr, flowKt__ZipKt$combine$5$1, new FlowKt__ZipKt$combine$5$2(this.$transform$inlined, null), x30Var);
    ...
    public Object collect$$forInline(FlowCollector flowCollector, x30 x30Var) {
        j21.c(4);
        new ContinuationImpl(x30Var) { // from class: kotlinx.coroutines.flow.FlowKt__ZipKt$combine$$inlined$unsafeFlow$2.1
            int label;
        ...
        j21.c(0);
        CombineKt.combineInternal(flowCollector, flowArr, flowKt__ZipKt$combine$5$1, flowKt__ZipKt$combine$5$2, x30Var);
        j21.c(1);
        return k83.a;
    }
}
