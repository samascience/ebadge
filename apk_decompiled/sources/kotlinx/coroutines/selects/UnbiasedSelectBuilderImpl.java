...
public final class UnbiasedSelectBuilderImpl<R> extends UnbiasedSelectImplementation<R> {
    ...
    @h70(c = "kotlinx.coroutines.selects.UnbiasedSelectBuilderImpl$initSelectResult$1", f = "SelectOld.kt", l = {71}, m = "invokeSuspend")
    static final class AnonymousClass1 extends SuspendLambda implements or0 {
        int label;
        final /* synthetic */ UnbiasedSelectBuilderImpl<R> this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        AnonymousClass1(UnbiasedSelectBuilderImpl<R> unbiasedSelectBuilderImpl, x30 x30Var) {
            super(2, x30Var);
    ...
    public UnbiasedSelectBuilderImpl(x30 x30Var) {
