...
abstract class ParameterHandler<T> {
    ...
    static final class Body<T> extends ParameterHandler<T> {
        private final Converter<T, ff2> converter;

        Body(Converter<T, ff2> converter) {
    ...
    static final class Part<T> extends ParameterHandler<T> {
        ...
        Part(iw0 iw0Var, Converter<T, ff2> converter) {
            this.headers = iw0Var;
            this.converter = converter;
        }
    ...
    static final class PartMap<T> extends ParameterHandler<Map<String, T>> {
        ...
        private final Converter<T, ff2> valueConverter;

        PartMap(Converter<T, ff2> converter, String str) {
            this.valueConverter = converter;
        ...
        public void apply(RequestBuilder requestBuilder, @Nullable Map<String, T> map) throws IOException {
            ...
            for (Map.Entry<String, T> entry : map.entrySet()) {
                ...
                requestBuilder.addPart(iw0.e("Content-Disposition", "form-data; name=\"" + key + "\"", "Content-Transfer-Encoding", this.transferEncoding), this.valueConverter.convert(value));
            }
        }
    }
    ...
    static final class RawPart extends ParameterHandler<gm1.c> {
        ...
        /* JADX INFO: Access modifiers changed from: package-private */
        @Override // retrofit2.ParameterHandler
        public void apply(RequestBuilder requestBuilder, @Nullable gm1.c cVar) {
            if (cVar != null) {
