...
public abstract class Single<T> implements SingleSource<T> {
    ...
    public static <T> Single<T> ambArray(SingleSource<? extends T>... singleSourceArr) {
        ...
        return singleSourceArr.length == 1 ? wrap(singleSourceArr[0]) : RxJavaPlugins.onAssembly(new SingleAmb(singleSourceArr, null));
    }
    ...
    public static <T> Flowable<T> concatEager(i92 i92Var) {
        return Flowable.fromPublisher(i92Var).concatMapEager(SingleInternalHelper.toFlowable());
    }
    ...
    @CheckReturnValue
    @NonNull
    public static <T> Single<T> fromPublisher(i92 i92Var) {
        ObjectHelper.requireNonNull(i92Var, "publisher is null");
        return RxJavaPlugins.onAssembly(new SingleFromPublisher(i92Var));
    }
    ...
    @SchedulerSupport(SchedulerSupport.NONE)
    @CheckReturnValue
    public final Single<T> retryWhen(Function<? super Flowable<Throwable>, ? extends i92> function) {
    ...
    public static <T> Flowable<T> merge(i92 i92Var) {
        ...
        return RxJavaPlugins.onAssembly(new FlowableFlatMapPublisher(i92Var, SingleInternalHelper.toFlowable(), false, Integer.MAX_VALUE, Flowable.bufferSize()));
    }
    ...
    public static <T> Flowable<T> mergeDelayError(i92 i92Var) {
        ObjectHelper.requireNonNull(i92Var, "sources is null");
        return RxJavaPlugins.onAssembly(new FlowableFlatMapPublisher(i92Var, SingleInternalHelper.toFlowable(), true, Integer.MAX_VALUE, Flowable.bufferSize()));
    }
    ...
    @CheckReturnValue
    @NonNull
    public final <E> Single<T> takeUntil(i92 i92Var) {
        ObjectHelper.requireNonNull(i92Var, "other is null");
        return RxJavaPlugins.onAssembly(new SingleTakeUntil(this, i92Var));
    }
    ...
    public static <T> Flowable<T> concat(i92 i92Var, int i) {
        ...
        return RxJavaPlugins.onAssembly(new FlowableConcatMapPublisher(i92Var, SingleInternalHelper.toFlowable(), i, ErrorMode.IMMEDIATE));
    }
    ...
    @CheckReturnValue
    @NonNull
    public final <U> Single<T> delaySubscription(i92 i92Var) {
        ObjectHelper.requireNonNull(i92Var, "other is null");
        return RxJavaPlugins.onAssembly(new SingleDelayWithPublisher(this, i92Var));
    }
