...
public abstract class Completable implements CompletableSource {
    ...
    public static Completable ambArray(CompletableSource... completableSourceArr) {
        ...
        return completableSourceArr.length == 1 ? wrap(completableSourceArr[0]) : RxJavaPlugins.onAssembly(new CompletableAmb(completableSourceArr, null));
    }
    ...
    public static Completable concatArray(CompletableSource... completableSourceArr) {
        ...
        return completableSourceArr.length == 1 ? wrap(completableSourceArr[0]) : RxJavaPlugins.onAssembly(new CompletableConcatArray(completableSourceArr));
    }
    ...
    @CheckReturnValue
    @NonNull
    public static <T> Completable fromPublisher(i92 i92Var) {
        ObjectHelper.requireNonNull(i92Var, "publisher is null");
        return RxJavaPlugins.onAssembly(new CompletableFromPublisher(i92Var));
    }
    ...
    @CheckReturnValue
    @NonNull
    private static Completable merge0(i92 i92Var, int i, boolean z) {
        ObjectHelper.requireNonNull(i92Var, "sources is null");
        ObjectHelper.verifyPositive(i, "maxConcurrency");
        return RxJavaPlugins.onAssembly(new CompletableMerge(i92Var, i, z));
    }
    ...
    public static Completable mergeArray(CompletableSource... completableSourceArr) {
        ...
        return completableSourceArr.length == 1 ? wrap(completableSourceArr[0]) : RxJavaPlugins.onAssembly(new CompletableMergeArray(completableSourceArr));
    }
    ...
    @SchedulerSupport(SchedulerSupport.NONE)
    @CheckReturnValue
    public final Completable repeatWhen(Function<? super Flowable<Object>, ? extends i92> function) {
    ...
    @SchedulerSupport(SchedulerSupport.NONE)
    @CheckReturnValue
    public final Completable retryWhen(Function<? super Flowable<Throwable>, ? extends i92> function) {
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static Completable concat(i92 i92Var) {
    ...
    @BackpressureSupport(BackpressureKind.UNBOUNDED_IN)
    @CheckReturnValue
    public static Completable merge(i92 i92Var) {
        return merge0(i92Var, Integer.MAX_VALUE, false);
    }

    @SchedulerSupport(SchedulerSupport.NONE)
    @BackpressureSupport(BackpressureKind.UNBOUNDED_IN)
    @CheckReturnValue
    public static Completable mergeDelayError(i92 i92Var) {
        return merge0(i92Var, Integer.MAX_VALUE, true);
    }
    ...
    @CheckReturnValue
    @NonNull
    public final <T> Flowable<T> andThen(i92 i92Var) {
        ObjectHelper.requireNonNull(i92Var, "next is null");
        return RxJavaPlugins.onAssembly(new CompletableAndThenPublisher(this, i92Var));
    }
    ...
    @CheckReturnValue
    @NonNull
    public static Completable concat(i92 i92Var, int i) {
        ObjectHelper.requireNonNull(i92Var, "sources is null");
        ObjectHelper.verifyPositive(i, "prefetch");
        return RxJavaPlugins.onAssembly(new CompletableConcat(i92Var, i));
    }

    @SchedulerSupport(SchedulerSupport.NONE)
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static Completable merge(i92 i92Var, int i) {
        return merge0(i92Var, i, false);
    }

    @SchedulerSupport(SchedulerSupport.NONE)
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static Completable mergeDelayError(i92 i92Var, int i) {
        return merge0(i92Var, i, true);
    }
    ...
    @CheckReturnValue
    @NonNull
    public final <T> Flowable<T> startWith(i92 i92Var) {
        ObjectHelper.requireNonNull(i92Var, "other is null");
        return toFlowable().startWith(i92Var);
    }
