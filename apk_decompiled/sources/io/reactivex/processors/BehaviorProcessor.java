...
public final class BehaviorProcessor<T> extends FlowableProcessor<T> {
    ...
    static final class BehaviorSubscription<T> extends AtomicLong implements dw2, AppendOnlyLinkedArrayList.NonThrowingPredicate<Object> {
        ...
        BehaviorSubscription(cw2 cw2Var, BehaviorProcessor<T> behaviorProcessor) {
    ...
    boolean add(BehaviorSubscription<T> behaviorSubscription) {
        ...
        } while (!p62.a(this.subscribers, behaviorSubscriptionArr, behaviorSubscriptionArr2));
        return true;
    }
    ...
    public void onComplete() {
        if (p62.a(this.terminalEvent, null, ExceptionHelper.TERMINATED)) {
    ...
    public void onError(Throwable th) {
        ...
        if (!p62.a(this.terminalEvent, null, th)) {
    ...
    protected void subscribeActual(cw2 cw2Var) {
        BehaviorSubscription<T> behaviorSubscription = new BehaviorSubscription<>(cw2Var, this);
        cw2Var.onSubscribe(behaviorSubscription);
