...
public final class PublishProcessor<T> extends FlowableProcessor<T> {
    ...
    static final class PublishSubscription<T> extends AtomicLong implements dw2 {
        private static final long serialVersionUID = 3562861878281475070L;
        final cw2 downstream;
        final PublishProcessor<T> parent;

        PublishSubscription(cw2 cw2Var, PublishProcessor<T> publishProcessor) {
    ...
    boolean add(PublishSubscription<T> publishSubscription) {
        ...
        } while (!p62.a(this.subscribers, publishSubscriptionArr, publishSubscriptionArr2));
        return true;
    }
    ...
    protected void subscribeActual(cw2 cw2Var) {
        PublishSubscription<T> publishSubscription = new PublishSubscription<>(cw2Var, this);
        cw2Var.onSubscribe(publishSubscription);
