...
public abstract class ParallelFlowable<T> {
    @CheckReturnValue
    public static <T> ParallelFlowable<T> from(@NonNull i92 i92Var) {
        return from(i92Var, Runtime.getRuntime().availableProcessors(), Flowable.bufferSize());
    }

    @CheckReturnValue
    @NonNull
    public static <T> ParallelFlowable<T> fromArray(@NonNull i92... i92VarArr) {
        if (i92VarArr.length != 0) {
            return RxJavaPlugins.onAssembly(new ParallelFromArray(i92VarArr));
        }
    ...
    @CheckReturnValue
    @NonNull
    public final <R> ParallelFlowable<R> concatMap(@NonNull Function<? super T, ? extends i92> function) {
        return concatMap(function, 2);
    }

    @CheckReturnValue
    @NonNull
    public final <R> ParallelFlowable<R> concatMapDelayError(@NonNull Function<? super T, ? extends i92> function, boolean z) {
    ...
    @CheckReturnValue
    @NonNull
    public final ParallelFlowable<T> doOnSubscribe(@NonNull Consumer<? super dw2> consumer) {
    ...
    @CheckReturnValue
    @NonNull
    public final <R> ParallelFlowable<R> flatMap(@NonNull Function<? super T, ? extends i92> function) {
    ...
    public abstract void subscribe(@NonNull cw2[] cw2VarArr);
    ...
    protected final boolean validate(@NonNull cw2[] cw2VarArr) {
        int iParallelism = parallelism();
        if (cw2VarArr.length == iParallelism) {
            return true;
        }
        IllegalArgumentException illegalArgumentException = new IllegalArgumentException("parallelism = " + iParallelism + ", subscribers = " + cw2VarArr.length);
        int length = cw2VarArr.length;
        for (int i = 0; i < length; i++) {
            EmptySubscription.error(illegalArgumentException, cw2VarArr[i]);
        }
        return false;
    }

    @CheckReturnValue
    public static <T> ParallelFlowable<T> from(@NonNull i92 i92Var, int i) {
        return from(i92Var, i, Flowable.bufferSize());
    }

    @CheckReturnValue
    @NonNull
    public final <R> ParallelFlowable<R> concatMap(@NonNull Function<? super T, ? extends i92> function, int i) {
    ...
    @CheckReturnValue
    @NonNull
    public final <R> ParallelFlowable<R> concatMapDelayError(@NonNull Function<? super T, ? extends i92> function, int i, boolean z) {
        ObjectHelper.requireNonNull(function, "mapper is null");
        ObjectHelper.verifyPositive(i, "prefetch");
    ...
    @CheckReturnValue
    @NonNull
    public final <R> ParallelFlowable<R> flatMap(@NonNull Function<? super T, ? extends i92> function, boolean z) {
    ...
    @CheckReturnValue
    @NonNull
    public static <T> ParallelFlowable<T> from(@NonNull i92 i92Var, int i, int i2) {
        ObjectHelper.requireNonNull(i92Var, SocialConstants.PARAM_SOURCE);
        ObjectHelper.verifyPositive(i, "parallelism");
        ObjectHelper.verifyPositive(i2, "prefetch");
        return RxJavaPlugins.onAssembly(new ParallelFromPublisher(i92Var, i, i2));
    }
    ...
    @CheckReturnValue
    @NonNull
    public final <R> ParallelFlowable<R> flatMap(@NonNull Function<? super T, ? extends i92> function, boolean z, int i) {
    ...
    @CheckReturnValue
    @NonNull
    public final <R> ParallelFlowable<R> flatMap(@NonNull Function<? super T, ? extends i92> function, boolean z, int i, int i2) {
        ObjectHelper.requireNonNull(function, "mapper is null");
