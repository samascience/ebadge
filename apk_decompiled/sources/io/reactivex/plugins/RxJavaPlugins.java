...
public final class RxJavaPlugins {
    ...
    @Nullable
    static volatile BiFunction<? super Flowable, ? super cw2, ? extends cw2> onFlowableSubscribe;
    ...
    @Nullable
    public static BiFunction<? super Flowable, ? super cw2, ? extends cw2> getOnFlowableSubscribe() {
    ...
    @NonNull
    public static <T> cw2 onSubscribe(@NonNull Flowable<T> flowable, @NonNull cw2 cw2Var) {
        BiFunction<? super Flowable, ? super cw2, ? extends cw2> biFunction = onFlowableSubscribe;
        return biFunction != null ? (cw2) apply(biFunction, flowable, cw2Var) : cw2Var;
    }
    ...
    public static void setOnFlowableSubscribe(@Nullable BiFunction<? super Flowable, ? super cw2, ? extends cw2> biFunction) {
        if (lockdown) {
            throw new IllegalStateException("Plugins can't be changed anymore");
        }
