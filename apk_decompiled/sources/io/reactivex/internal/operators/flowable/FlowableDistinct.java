...
public final class FlowableDistinct<T, K> extends AbstractFlowableWithUpstream<T, T> {
    ...
    static final class DistinctSubscriber<T, K> extends BasicFuseableSubscriber<T, T> {
        ...
        DistinctSubscriber(cw2 cw2Var, Function<? super T, K> function, Collection<? super K> collection) {
            super(cw2Var);
    ...
    protected void subscribeActual(cw2 cw2Var) {
        try {
            this.source.subscribe((FlowableSubscriber) new DistinctSubscriber(cw2Var, this.keySelector, (Collection) ObjectHelper.requireNonNull(this.collectionSupplier.call(), "The collectionSupplier returned a null collection. Null values are generally not allowed in 2.x operators and sources.")));
        } catch (Throwable th) {
