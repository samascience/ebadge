...
public final class FlowableInterval extends Flowable<Long> {
    ...
    static final class IntervalSubscriber extends AtomicLong implements dw2, Runnable {
        private static final long serialVersionUID = -2809475196591179431L;
        long count;
        final cw2 downstream;
        final AtomicReference<Disposable> resource = new AtomicReference<>();

        IntervalSubscriber(cw2 cw2Var) {
    ...
    public void subscribeActual(cw2 cw2Var) {
        IntervalSubscriber intervalSubscriber = new IntervalSubscriber(cw2Var);
        cw2Var.onSubscribe(intervalSubscriber);
