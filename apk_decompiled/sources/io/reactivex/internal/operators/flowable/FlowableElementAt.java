...
public final class FlowableElementAt<T> extends AbstractFlowableWithUpstream<T, T> {
    ...
    static final class ElementAtSubscriber<T> extends DeferredScalarSubscription<T> implements FlowableSubscriber<T> {
        ...
        ElementAtSubscriber(cw2 cw2Var, long j, T t, boolean z) {
            super(cw2Var);
            this.index = j;
            this.defaultValue = t;
            this.errorOnFewer = z;
    ...
    protected void subscribeActual(cw2 cw2Var) {
        this.source.subscribe((FlowableSubscriber) new ElementAtSubscriber(cw2Var, this.index, this.defaultValue, this.errorOnFewer));
    }
}
