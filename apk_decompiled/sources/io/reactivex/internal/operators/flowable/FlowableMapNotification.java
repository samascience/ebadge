...
public final class FlowableMapNotification<T, R> extends AbstractFlowableWithUpstream<T, R> {
    ...
    static final class MapNotificationSubscriber<T, R> extends SinglePostCompleteSubscriber<T, R> {
        ...
        MapNotificationSubscriber(cw2 cw2Var, Function<? super T, ? extends R> function, Function<? super Throwable, ? extends R> function2, Callable<? extends R> callable) {
            super(cw2Var);
    ...
    protected void subscribeActual(cw2 cw2Var) {
        this.source.subscribe((FlowableSubscriber) new MapNotificationSubscriber(cw2Var, this.onNextMapper, this.onErrorMapper, this.onCompleteSupplier));
    }
}
