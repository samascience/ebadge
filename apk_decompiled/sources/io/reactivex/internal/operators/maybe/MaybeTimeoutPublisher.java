...
public final class MaybeTimeoutPublisher<T, U> extends AbstractMaybeWithUpstream<T, T> {
    ...
    static final class TimeoutOtherMaybeObserver<T, U> extends AtomicReference<dw2> implements FlowableSubscriber<Object> {
        private static final long serialVersionUID = 8663801314800248617L;
    ...
    public MaybeTimeoutPublisher(MaybeSource<T> maybeSource, i92 i92Var, MaybeSource<? extends T> maybeSource2) {
        super(maybeSource);
        this.other = i92Var;
