...
public final class SingleTakeUntil<T, U> extends Single<T> {
    ...
    static final class TakeUntilOtherSubscriber extends AtomicReference<dw2> implements FlowableSubscriber<Object> {
    ...
    public SingleTakeUntil(SingleSource<T> singleSource, i92 i92Var) {
