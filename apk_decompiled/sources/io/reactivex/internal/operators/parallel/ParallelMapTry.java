...
public final class ParallelMapTry<T, R> extends ParallelFlowable<R> {
    ...
    static final class ParallelMapTryConditionalSubscriber<T, R> implements ConditionalSubscriber<T>, dw2 {
        boolean done;
    ...
    static final class ParallelMapTrySubscriber<T, R> implements ConditionalSubscriber<T>, dw2 {
        boolean done;
        ...
        ParallelMapTrySubscriber(cw2 cw2Var, Function<? super T, ? extends R> function, BiFunction<? super Long, ? super Throwable, ParallelFailureHandling> biFunction) {
        ...
        if (validate(cw2VarArr)) {
            ...
            for (int i = 0; i < length; i++) {
                ...
                if (cw2Var instanceof ConditionalSubscriber) {
                    cw2VarArr2[i] = new ParallelMapTryConditionalSubscriber((ConditionalSubscriber) cw2Var, this.mapper, this.errorHandler);
                } else {
                    cw2VarArr2[i] = new ParallelMapTrySubscriber(cw2Var, this.mapper, this.errorHandler);
                }
            }
