...
public final class Functions {
    ...
    public static final Consumer<dw2> REQUEST_MAX = new MaxRequestSubscription();
    ...
    public static class BoundedConsumer implements Consumer<dw2> {
    ...
    static final class MaxRequestSubscription implements Consumer<dw2> {
