...
public abstract class Maybe<T> implements MaybeSource<T> {
    ...
    public static <T> Maybe<T> ambArray(MaybeSource<? extends T>... maybeSourceArr) {
        ...
        return maybeSourceArr.length == 1 ? wrap(maybeSourceArr[0]) : RxJavaPlugins.onAssembly(new MaybeAmb(maybeSourceArr, null));
    }
    ...
    public static <T> Flowable<T> concatArray(MaybeSource<? extends T>... maybeSourceArr) {
        ...
        return maybeSourceArr.length == 1 ? RxJavaPlugins.onAssembly(new MaybeToFlowable(maybeSourceArr[0])) : RxJavaPlugins.onAssembly(new MaybeConcatArray(maybeSourceArr));
    }
    ...
    public static <T> Flowable<T> concatArrayDelayError(MaybeSource<? extends T>... maybeSourceArr) {
        ...
        return maybeSourceArr.length == 1 ? RxJavaPlugins.onAssembly(new MaybeToFlowable(maybeSourceArr[0])) : RxJavaPlugins.onAssembly(new MaybeConcatArrayDelayError(maybeSourceArr));
    }
    ...
    public static <T> Flowable<T> mergeArray(MaybeSource<? extends T>... maybeSourceArr) {
        ...
        return maybeSourceArr.length == 1 ? RxJavaPlugins.onAssembly(new MaybeToFlowable(maybeSourceArr[0])) : RxJavaPlugins.onAssembly(new MaybeMergeArray(maybeSourceArr));
    }
    ...
    @CheckReturnValue
    @NonNull
    public final <U> Maybe<T> delaySubscription(i92 i92Var) {
        ObjectHelper.requireNonNull(i92Var, "subscriptionIndicator is null");
        return RxJavaPlugins.onAssembly(new MaybeDelaySubscriptionOtherPublisher(this, i92Var));
    }
    ...
    @CheckReturnValue
    @NonNull
    public final <R> Flowable<R> flatMapPublisher(Function<? super T, ? extends i92> function) {
        ObjectHelper.requireNonNull(function, "mapper is null");
    ...
    @SchedulerSupport(SchedulerSupport.NONE)
    @CheckReturnValue
    public final Maybe<T> retryWhen(Function<? super Flowable<Throwable>, ? extends i92> function) {
    ...
    public static <T> Flowable<T> concatEager(i92 i92Var) {
        return Flowable.fromPublisher(i92Var).concatMapEager(MaybeToPublisher.instance());
    }
    ...
    public static <T> Flowable<T> merge(i92 i92Var) {
        return merge(i92Var, Integer.MAX_VALUE);
    }
    ...
    public static <T> Flowable<T> mergeDelayError(i92 i92Var) {
        return mergeDelayError(i92Var, Integer.MAX_VALUE);
    }
    ...
    public static <T> Flowable<T> concatDelayError(i92 i92Var) {
        return Flowable.fromPublisher(i92Var).concatMapDelayError(MaybeToPublisher.instance());
    }
    ...
    public static <T> Flowable<T> merge(i92 i92Var, int i) {
        ...
        return RxJavaPlugins.onAssembly(new FlowableFlatMapPublisher(i92Var, MaybeToPublisher.instance(), false, i, 1));
    }
    ...
    public static <T> Flowable<T> mergeDelayError(i92 i92Var, int i) {
        ObjectHelper.requireNonNull(i92Var, "source is null");
        ObjectHelper.verifyPositive(i, "maxConcurrency");
        return RxJavaPlugins.onAssembly(new FlowableFlatMapPublisher(i92Var, MaybeToPublisher.instance(), true, i, 1));
    }
    ...
    @CheckReturnValue
    @NonNull
    public final <U> Maybe<T> takeUntil(i92 i92Var) {
        ObjectHelper.requireNonNull(i92Var, "other is null");
        return RxJavaPlugins.onAssembly(new MaybeTakeUntilPublisher(this, i92Var));
    }
    ...
    @CheckReturnValue
    @NonNull
    public final <U, V> Maybe<T> delay(i92 i92Var) {
        ObjectHelper.requireNonNull(i92Var, "delayIndicator is null");
        return RxJavaPlugins.onAssembly(new MaybeDelayOtherPublisher(this, i92Var));
    }
    ...
    @CheckReturnValue
    @NonNull
    public final <U> Maybe<T> timeout(i92 i92Var) {
        ObjectHelper.requireNonNull(i92Var, "timeoutIndicator is null");
        return RxJavaPlugins.onAssembly(new MaybeTimeoutPublisher(this, i92Var, null));
    }
    ...
    @CheckReturnValue
    @NonNull
    public final <U> Maybe<T> timeout(i92 i92Var, MaybeSource<? extends T> maybeSource) {
        ObjectHelper.requireNonNull(i92Var, "timeoutIndicator is null");
        ObjectHelper.requireNonNull(maybeSource, "fallback is null");
        return RxJavaPlugins.onAssembly(new MaybeTimeoutPublisher(this, i92Var, maybeSource));
    }
    ...
    public static <T> Flowable<T> concat(i92 i92Var, int i) {
        ...
        return RxJavaPlugins.onAssembly(new FlowableConcatMapPublisher(i92Var, MaybeToPublisher.instance(), i, ErrorMode.IMMEDIATE));
    }
