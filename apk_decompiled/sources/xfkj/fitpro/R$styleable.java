...
public final class R$styleable {
    ...
    public static final int Battery_batteryBatteryColor = 0;
    public static final int Battery_batteryColor = 1;
    public static final int Battery_batteryHeaderColor = 2;
    public static final int Battery_batteryOrientation = 3;
    public static final int Battery_batteryPower = 4;
    ...
    public static final int BigSmallTextView_bsBigFontColor = 0;
    public static final int BigSmallTextView_bsBigFontSize = 1;
    public static final int BigSmallTextView_bsBigFontText = 2;
    public static final int BigSmallTextView_bsSmallFontColor = 3;
    public static final int BigSmallTextView_bsSmallFontSize = 4;
    public static final int BigSmallTextView_bsSmallFontText = 5;
    public static final int BigSmallTextView_bsSpace = 6;
    ...
    public static final int CircleDoubleProgressView_cdpvBlockAngle = 0;
    public static final int CircleDoubleProgressView_cdpvCapRound = 1;
    public static final int CircleDoubleProgressView_cdpvCirclePadding = 2;
    public static final int CircleDoubleProgressView_cdpvDuration = 3;
    public static final int CircleDoubleProgressView_cdpvLabelIcon = 4;
    public static final int CircleDoubleProgressView_cdpvLabelIconColor = 5;
    public static final int CircleDoubleProgressView_cdpvLabelIconSize = 6;
    public static final int CircleDoubleProgressView_cdpvLabelPaddingBottom = 7;
    public static final int CircleDoubleProgressView_cdpvLabelPaddingLeft = 8;
    public static final int CircleDoubleProgressView_cdpvLabelPaddingRight = 9;
    public static final int CircleDoubleProgressView_cdpvLabelPaddingTop = 10;
    public static final int CircleDoubleProgressView_cdpvLabelText = 11;
    public static final int CircleDoubleProgressView_cdpvLabelTextColor = 12;
    public static final int CircleDoubleProgressView_cdpvLabelTextSize = 13;
    public static final int CircleDoubleProgressView_cdpvMax1 = 14;
    public static final int CircleDoubleProgressView_cdpvMax2 = 15;
    public static final int CircleDoubleProgressView_cdpvNormal1Color = 16;
    public static final int CircleDoubleProgressView_cdpvNormal2Color = 17;
    public static final int CircleDoubleProgressView_cdpvNormalProgressStrokeWidth = 18;
    public static final int CircleDoubleProgressView_cdpvProgress1 = 19;
    public static final int CircleDoubleProgressView_cdpvProgress1Color = 20;
    public static final int CircleDoubleProgressView_cdpvProgress2 = 21;
    public static final int CircleDoubleProgressView_cdpvProgress2Color = 22;
    public static final int CircleDoubleProgressView_cdpvProgressStrokeWidth = 23;
    public static final int CircleDoubleProgressView_cdpvShowArrow = 24;
    public static final int CircleDoubleProgressView_cdpvShowLabel = 25;
    public static final int CircleDoubleProgressView_cdpvShowLabelIcon = 26;
    public static final int CircleDoubleProgressView_cdpvShowLabelIconShadow = 27;
    public static final int CircleDoubleProgressView_cdpvShowTick = 28;
    public static final int CircleDoubleProgressView_cdpvSpace = 29;
    public static final int CircleDoubleProgressView_cdpvStartAngle = 30;
    public static final int CircleDoubleProgressView_cdpvSweepAngle = 31;
    public static final int CircleDoubleProgressView_cdpvTickSplitAngle = 32;
    public static final int CircleDoubleProgressView_cdpvTurn = 33;
    ...
    public static final int CircleProgressView_cpvLabelIcon = 4;
    public static final int CircleProgressView_cpvLabelIconColor = 5;
    public static final int CircleProgressView_cpvLabelIconSize = 6;
    public static final int CircleProgressView_cpvLabelPaddingBottom = 7;
    public static final int CircleProgressView_cpvLabelPaddingLeft = 8;
    public static final int CircleProgressView_cpvLabelPaddingRight = 9;
    public static final int CircleProgressView_cpvLabelPaddingTop = 10;
    public static final int CircleProgressView_cpvLabelText = 11;
    public static final int CircleProgressView_cpvLabelTextColor = 12;
    public static final int CircleProgressView_cpvLabelTextSize = 13;
    public static final int CircleProgressView_cpvMax = 14;
    public static final int CircleProgressView_cpvNormalColor = 15;
    public static final int CircleProgressView_cpvNormalProgressStrokeWidth = 16;
    public static final int CircleProgressView_cpvProgress = 17;
    public static final int CircleProgressView_cpvProgressColor = 18;
    public static final int CircleProgressView_cpvProgressStrokeWidth = 19;
    public static final int CircleProgressView_cpvShowArrow = 20;
    public static final int CircleProgressView_cpvShowLabel = 21;
    public static final int CircleProgressView_cpvShowLabelIcon = 22;
    public static final int CircleProgressView_cpvShowLabelIconShadow = 23;
    public static final int CircleProgressView_cpvShowTick = 24;
    public static final int CircleProgressView_cpvStartAngle = 25;
    public static final int CircleProgressView_cpvSweepAngle = 26;
    public static final int CircleProgressView_cpvTickSplitAngle = 27;
    public static final int CircleProgressView_cpvTurn = 28;
    public static final int CircleProgress_decimalPointLength = 0;
    public static final int CircleProgress_disableAngle = 1;
    public static final int CircleProgress_duration = 2;
    public static final int CircleProgress_isClockwise = 3;
    public static final int CircleProgress_isDecimal = 4;
    public static final int CircleProgress_isRound = 5;
    public static final int CircleProgress_isShowPercentText = 6;
    public static final int CircleProgress_maxProgress = 7;
    public static final int CircleProgress_myTextColor = 8;
    public static final int CircleProgress_myTextSize = 9;
    public static final int CircleProgress_neiYuanColor = 10;
    public static final int CircleProgress_progress = 11;
    public static final int CircleProgress_ringColor = 12;
    public static final int CircleProgress_ringProgressColor = 13;
    public static final int CircleProgress_ringProgressSecondColor = 14;
    public static final int CircleProgress_ringRadius = 15;
    public static final int CircleProgress_ringWidth = 16;
    public static final int CircleProgress_startAngle = 17;
    public static final int CircleProgress_useAnimation = 18;
    public static final int CircleThreeProgressView_ctpvBlockAngle = 0;
    public static final int CircleThreeProgressView_ctpvCapRound = 1;
    public static final int CircleThreeProgressView_ctpvCirclePadding = 2;
    public static final int CircleThreeProgressView_ctpvDuration = 3;
    public static final int CircleThreeProgressView_ctpvIcon1 = 4;
    public static final int CircleThreeProgressView_ctpvIcon1BgColor = 5;
    public static final int CircleThreeProgressView_ctpvIcon2 = 6;
    public static final int CircleThreeProgressView_ctpvIcon2BgColor = 7;
    public static final int CircleThreeProgressView_ctpvIcon3 = 8;
    public static final int CircleThreeProgressView_ctpvIcon3BgColor = 9;
    public static final int CircleThreeProgressView_ctpvLabelIcon = 10;
    public static final int CircleThreeProgressView_ctpvLabelIconColor = 11;
    public static final int CircleThreeProgressView_ctpvLabelIconSize = 12;
    public static final int CircleThreeProgressView_ctpvLabelPaddingBottom = 13;
    public static final int CircleThreeProgressView_ctpvLabelPaddingLeft = 14;
    public static final int CircleThreeProgressView_ctpvLabelPaddingRight = 15;
    public static final int CircleThreeProgressView_ctpvLabelPaddingTop = 16;
    public static final int CircleThreeProgressView_ctpvLabelText = 17;
    public static final int CircleThreeProgressView_ctpvLabelTextColor = 18;
    public static final int CircleThreeProgressView_ctpvLabelTextSize = 19;
    public static final int CircleThreeProgressView_ctpvMax1 = 20;
    public static final int CircleThreeProgressView_ctpvMax2 = 21;
    public static final int CircleThreeProgressView_ctpvMax3 = 22;
    public static final int CircleThreeProgressView_ctpvNormal1Color = 23;
    public static final int CircleThreeProgressView_ctpvNormal2Color = 24;
    public static final int CircleThreeProgressView_ctpvNormal3Color = 25;
    public static final int CircleThreeProgressView_ctpvNormalProgressStrokeWidth = 26;
    public static final int CircleThreeProgressView_ctpvProgress1 = 27;
    public static final int CircleThreeProgressView_ctpvProgress1Color = 28;
    public static final int CircleThreeProgressView_ctpvProgress2 = 29;
    public static final int CircleThreeProgressView_ctpvProgress2Color = 30;
    public static final int CircleThreeProgressView_ctpvProgress3 = 31;
    public static final int CircleThreeProgressView_ctpvProgress3Color = 32;
    public static final int CircleThreeProgressView_ctpvProgressStrokeWidth = 33;
    public static final int CircleThreeProgressView_ctpvShowArrow = 34;
    public static final int CircleThreeProgressView_ctpvShowIconBg = 35;
    public static final int CircleThreeProgressView_ctpvShowLabel = 36;
    public static final int CircleThreeProgressView_ctpvShowLabelIcon = 37;
    public static final int CircleThreeProgressView_ctpvShowLabelIconShadow = 38;
    public static final int CircleThreeProgressView_ctpvShowTick = 39;
    public static final int CircleThreeProgressView_ctpvSpace = 40;
    public static final int CircleThreeProgressView_ctpvStartAngle = 41;
    public static final int CircleThreeProgressView_ctpvSweepAngle = 42;
    public static final int CircleThreeProgressView_ctpvTickSplitAngle = 43;
    public static final int CircleThreeProgressView_ctpvTurn = 44;
    ...
    public static final int ColorPannelView_ColorPannelColor = 0;
    public static final int ColorPannelView_ColorPannelViewRadius = 1;
    ...
    public static final int DotTextView_dotColor = 0;
    public static final int DotTextView_dotGravity = 1;
    public static final int DotTextView_dotOffsetX = 2;
    public static final int DotTextView_dotOffsetY = 3;
    public static final int DotTextView_dotRadius = 4;
    public static final int DotTextView_isDebug = 5;
    public static final int DotTextView_showDot = 6;
    ...
    public static final int ECGChartView_canLineBound = 0;
    public static final int ECGChartView_ecgBackgroundColor = 1;
    public static final int ECGChartView_ecgDrawColor = 2;
    public static final int ECGChartView_ecgInnerColor = 3;
    public static final int ECGChartView_ecgLineCount = 4;
    public static final int ECGChartView_ecgOuterColor = 5;
    public static final int ECGChartView_ecgportSpace = 6;
    public static final int ECGChartView_isTouchable = 7;
    public static final int ECGChartView_markTextStyle = 8;
    public static final int ECGChartView_yOuterCellCounts = 9;
    ...
    public static final int GradeRadioStyle_radSize = 0;
    ...
    public static final int HLabelTextView_hlt_isRect = 0;
    public static final int HLabelTextView_hlt_label_color = 1;
    public static final int HLabelTextView_hlt_label_size = 2;
    public static final int HLabelTextView_hlt_label_text = 3;
    public static final int HLabelTextView_hlt_label_text_color = 4;
    public static final int HLabelTextView_hlt_label_text_size = 5;
    public static final int HLabelTextView_hlt_padding = 6;
    public static final int HLabelTextView_hlt_text = 7;
    public static final int HLabelTextView_hlt_text_color = 8;
    public static final int HLabelTextView_hlt_text_size = 9;
    ...
    public static final int MuiltLayerCircleProgressView_mcp_c1_normal_color = 0;
    public static final int MuiltLayerCircleProgressView_mcp_c1_progress_color = 1;
    public static final int MuiltLayerCircleProgressView_mcp_c2_normal_color = 2;
    public static final int MuiltLayerCircleProgressView_mcp_c2_progress_color = 3;
    public static final int MuiltLayerCircleProgressView_mcp_c3_normal_color = 4;
    public static final int MuiltLayerCircleProgressView_mcp_c3_progress_color = 5;
    public static final int MuiltLayerCircleProgressView_mcp_height = 6;
    public static final int MuiltLayerCircleProgressView_mcp_icon1 = 7;
    public static final int MuiltLayerCircleProgressView_mcp_icon1_bg_color = 8;
    public static final int MuiltLayerCircleProgressView_mcp_icon2 = 9;
    public static final int MuiltLayerCircleProgressView_mcp_icon2_bg_color = 10;
    public static final int MuiltLayerCircleProgressView_mcp_icon3 = 11;
    public static final int MuiltLayerCircleProgressView_mcp_icon3_bg_color = 12;
    public static final int MuiltLayerCircleProgressView_mcp_icon_size = 13;
    public static final int MuiltLayerCircleProgressView_mcp_isshow_icon = 14;
    public static final int MuiltLayerCircleProgressView_mcp_normal_stroke_width = 15;
    public static final int MuiltLayerCircleProgressView_mcp_progress_stroke_width = 16;
    public static final int MuiltLayerCircleProgressView_mcp_space_width = 17;
    public static final int MuiltLayerCircleProgressView_mcp_start_angle = 18;
    public static final int MuiltLayerCircleProgressView_mcp_width = 19;
    ...
    public static final int MyCircleBar_circle_center_color = 0;
    public static final int MyCircleBar_circle_end_color = 1;
    public static final int MyCircleBar_circle_gradient_on = 2;
    public static final int MyCircleBar_circle_hint_text_color = 3;
    public static final int MyCircleBar_circle_max_progress = 4;
    public static final int MyCircleBar_circle_ring_angle_type = 5;
    public static final int MyCircleBar_circle_ring_reached = 6;
    public static final int MyCircleBar_circle_ring_un_reached = 7;
    public static final int MyCircleBar_circle_ring_width = 8;
    public static final int MyCircleBar_circle_show_progress = 9;
    public static final int MyCircleBar_circle_show_scale_color = 10;
    public static final int MyCircleBar_circle_show_scale_on = 11;
    public static final int MyCircleBar_circle_show_text_color = 12;
    public static final int MyCircleBar_circle_start_color = 13;
    public static final int MyCircleProgressBar_cpb_duration = 0;
    public static final int MyCircleProgressBar_cpb_endColor = 1;
    public static final int MyCircleProgressBar_cpb_startColor = 2;
    public static final int MyCircleProgressBar_cpb_strokeWidth = 3;
    ...
    public static final int NumberProgressBar_number_progress_reached_bar_height = 2;
    public static final int NumberProgressBar_number_progress_reached_color = 3;
    public static final int NumberProgressBar_number_progress_text_color = 4;
    public static final int NumberProgressBar_number_progress_text_offset = 5;
    public static final int NumberProgressBar_number_progress_text_size = 6;
    public static final int NumberProgressBar_number_progress_text_visibility = 7;
    public static final int NumberProgressBar_number_progress_unreached_bar_height = 8;
    public static final int NumberProgressBar_number_progress_unreached_color = 9;
    ...
    public static final int PasswordEditText_pet_disableIconAlpha = 0;
    ...
    public static final int PasswordEditText_pet_iconlabel = 4;
    public static final int PasswordEditText_pet_nonMonospaceFont = 5;
    public static final int PasswordEditText_pet_showIconlabel = 6;
    ...
    public static final int PolygonView_cv_border_color = 0;
    public static final int PolygonView_cv_fill_color = 1;
    public static final int PolygonView_cv_isRect = 2;
    public static final int PolygonView_cv_radius = 3;
    public static final int PolygonView_cv_show_stroke = 4;
    public static final int PolygonView_cv_stroke_width = 5;
    ...
    public static final int QQSportView_circle_width = 0;
    public static final int QQSportView_in_bg_color = 1;
    public static final int QQSportView_out_bg_color = 2;
    public static final int QQSportView_text_color = 3;
    public static final int QQSportView_text_size = 4;
    public static final int RadialViewGroup_materialCircleRadius = 0;
    public static final int RadioGroupSelector_rgs_left_text = 0;
    public static final int RadioGroupSelector_rgs_right_text = 1;
    ...
    public static final int RangeSeekBar_rsb_label = 14;
    public static final int RangeSeekBar_rsb_label_margin = 15;
    ...
    public static final int RangeSeekBar_rsb_orientation = 19;
    ...
    public static final int RangeSeekBar_rsb_progress_height = 22;
    public static final int RangeSeekBar_rsb_progress_radius = 23;
    public static final int RangeSeekBar_rsb_range_interval = 24;
    public static final int RangeSeekBar_rsb_start_vaule = 25;
    public static final int RangeSeekBar_rsb_thumb_drawable = 26;
    public static final int RangeSeekBar_rsb_thumb_inactivated_drawable = 27;
    public static final int RangeSeekBar_rsb_thumb_scale_ratio = 28;
    public static final int RangeSeekBar_rsb_thumb_size = 29;
    public static final int RangeSeekBar_rsb_tick_mark_gravity = 30;
    public static final int RangeSeekBar_rsb_tick_mark_in_range_text_color = 31;
    public static final int RangeSeekBar_rsb_tick_mark_label_text_array = 32;
    public static final int RangeSeekBar_rsb_tick_mark_mode = 33;
    public static final int RangeSeekBar_rsb_tick_mark_number = 34;
    public static final int RangeSeekBar_rsb_tick_mark_text_array = 35;
    public static final int RangeSeekBar_rsb_tick_mark_text_color = 36;
    public static final int RangeSeekBar_rsb_tick_mark_text_margin = 37;
    public static final int RangeSeekBar_rsb_tick_mark_text_size = 38;
    ...
    public static final int RunningCircleProgressView_runCpvBlockAngle = 0;
    public static final int RunningCircleProgressView_runCpvCapRound = 1;
    public static final int RunningCircleProgressView_runCpvCirclePadding = 2;
    public static final int RunningCircleProgressView_runCpvDuration = 3;
    public static final int RunningCircleProgressView_runCpvLabelIcon = 4;
    public static final int RunningCircleProgressView_runCpvLabelIconColor = 5;
    public static final int RunningCircleProgressView_runCpvLabelIconSize = 6;
    public static final int RunningCircleProgressView_runCpvLabelIconStrokeSize = 7;
    public static final int RunningCircleProgressView_runCpvLabelPaddingBottom = 8;
    public static final int RunningCircleProgressView_runCpvLabelPaddingLeft = 9;
    public static final int RunningCircleProgressView_runCpvLabelPaddingRight = 10;
    public static final int RunningCircleProgressView_runCpvLabelPaddingTop = 11;
    public static final int RunningCircleProgressView_runCpvLabelText = 12;
    public static final int RunningCircleProgressView_runCpvLabelTextColor = 13;
    public static final int RunningCircleProgressView_runCpvLabelTextSize = 14;
    public static final int RunningCircleProgressView_runCpvMax = 15;
    public static final int RunningCircleProgressView_runCpvNormalColor = 16;
    public static final int RunningCircleProgressView_runCpvNormalProgressStrokeWidth = 17;
    public static final int RunningCircleProgressView_runCpvProgress = 18;
    public static final int RunningCircleProgressView_runCpvProgressColor = 19;
    public static final int RunningCircleProgressView_runCpvProgressStrokeWidth = 20;
    public static final int RunningCircleProgressView_runCpvShaderColors = 21;
    public static final int RunningCircleProgressView_runCpvShowArrow = 22;
    public static final int RunningCircleProgressView_runCpvShowLabel = 23;
    public static final int RunningCircleProgressView_runCpvShowLabelIcon = 24;
    public static final int RunningCircleProgressView_runCpvShowLabelIconShadow = 25;
    public static final int RunningCircleProgressView_runCpvShowTick = 26;
    public static final int RunningCircleProgressView_runCpvStartAngle = 27;
    public static final int RunningCircleProgressView_runCpvSweepAngle = 28;
    public static final int RunningCircleProgressView_runCpvTickSplitAngle = 29;
    public static final int RunningCircleProgressView_runCpvTurn = 30;
    public static final int SMBanner_sm_banner_auto_loop = 0;
    public static final int SMBanner_sm_banner_indicator_gravity = 1;
    public static final int SMBanner_sm_banner_indicator_height = 2;
    public static final int SMBanner_sm_banner_indicator_margin = 3;
    public static final int SMBanner_sm_banner_indicator_marginBottom = 4;
    public static final int SMBanner_sm_banner_indicator_marginLeft = 5;
    public static final int SMBanner_sm_banner_indicator_marginRight = 6;
    public static final int SMBanner_sm_banner_indicator_marginTop = 7;
    public static final int SMBanner_sm_banner_indicator_normal_color = 8;
    public static final int SMBanner_sm_banner_indicator_normal_width = 9;
    public static final int SMBanner_sm_banner_indicator_radius = 10;
    public static final int SMBanner_sm_banner_indicator_selected_color = 11;
    public static final int SMBanner_sm_banner_indicator_selected_width = 12;
    public static final int SMBanner_sm_banner_indicator_space = 13;
    public static final int SMBanner_sm_banner_infinite_loop = 14;
    public static final int SMBanner_sm_banner_loop_time = 15;
    public static final int SMBanner_sm_banner_orientation = 16;
    public static final int SMBanner_sm_banner_radius = 17;
    public static final int SMBanner_sm_banner_round_bottom_left = 18;
    public static final int SMBanner_sm_banner_round_bottom_right = 19;
    public static final int SMBanner_sm_banner_round_top_left = 20;
    public static final int SMBanner_sm_banner_round_top_right = 21;
    public static final int SMDrawableIndicator_sm_normal_drawable = 0;
    public static final int SMDrawableIndicator_sm_selected_drawable = 1;
    public static final int SMRoundedImageView_sm_riv_radius = 0;
    public static final int SMRoundedImageView_sm_round_bottom_left_radius = 1;
    public static final int SMRoundedImageView_sm_round_bottom_right_radius = 2;
    public static final int SMRoundedImageView_sm_round_top_left_radius = 3;
    public static final int SMRoundedImageView_sm_round_top_right_radius = 4;
    public static final int ScalableImageView_scaleFrom = 0;
    public static final int ScalableImageView_scaleTo = 1;
    public static final int ScalableImageView_src = 2;
    ...
    public static final int SelectorImageView_siv_filter_color = 0;
    ...
    public static final int SignalView_rectBorderColor = 0;
    public static final int SignalView_rectBorderWidth = 1;
    public static final int SignalView_signalCount = 2;
    public static final int SignalView_signalHighColor = 3;
    public static final int SignalView_signalLowColor = 4;
    public static final int SignalView_signalMiddleColor = 5;
    public static final int SignalView_signalRectInterval = 6;
    public static final int SignalView_signalTypeTextColor = 7;
    public static final int SignalView_signalTypeTextSize = 8;
    public static final int SleepChartStyle_gt_circle_radius = 0;
    public static final int SleepChartStyle_gt_element_height = 1;
    public static final int SleepChartStyle_gt_element_line_height = 2;
    public static final int SleepChartStyle_gt_is_full_x_axis = 3;
    public static final int SleepChartStyle_gt_is_full_y_axis = 4;
    public static final int SleepChartStyle_gt_is_show_auxiliary_line = 5;
    public static final int SleepChartStyle_gt_is_show_by_time = 6;
    public static final int SleepChartStyle_gt_is_show_grid_line = 7;
    public static final int SleepChartStyle_gt_is_show_marker = 8;
    public static final int SleepChartStyle_gt_is_show_nav_bottom = 9;
    public static final int SleepChartStyle_gt_is_show_x_axias = 10;
    public static final int SleepChartStyle_gt_is_show_x_axias_text = 11;
    public static final int SleepChartStyle_gt_is_show_y_axias = 12;
    public static final int SleepChartStyle_gt_is_show_y_axias_text = 13;
    public static final int SleepChartStyle_gt_is_touch_event = 14;
    public static final int SleepChartStyle_gt_line_color = 15;
    public static final int SleepChartStyle_gt_line_width = 16;
    public static final int SleepChartStyle_gt_padding_top = 17;
    public static final int SleepChartStyle_gt_scale = 18;
    public static final int SleepChartStyle_gt_show_bubble = 19;
    public static final int SleepChartStyle_gt_text_size = 20;
    public static final int SleepViewStyle_sleep_background_color = 0;
    public static final int SleepViewStyle_sleep_deeps_color = 1;
    public static final int SleepViewStyle_sleep_lights_color = 2;
    public static final int SleepViewStyle_sleep_wakeups_color = 3;
    ...
    public static final int TapeView_maxValue = 6;
    public static final int TapeView_minValue = 7;
    public static final int TapeView_per = 8;
    public static final int TapeView_perCount = 9;
    public static final int TapeView_textColor = 10;
    public static final int TapeView_textSize = 11;
    public static final int TapeView_tpmaxValue = 12;
    public static final int TapeView_tpminValue = 13;
    public static final int TapeView_triangleColor = 14;
    public static final int TapeView_triangleHeight = 15;
    public static final int TapeView_value = 16;
    ...
    public static final int VerticalBigSmallTextView_vbsBigFontColor = 0;
    public static final int VerticalBigSmallTextView_vbsBigFontFamily = 1;
    public static final int VerticalBigSmallTextView_vbsBigFontSize = 2;
    public static final int VerticalBigSmallTextView_vbsBigFontText = 3;
    public static final int VerticalBigSmallTextView_vbsBigLabelFontColor = 4;
    public static final int VerticalBigSmallTextView_vbsBigLabelFontSize = 5;
    public static final int VerticalBigSmallTextView_vbsBigLabelFontText = 6;
    public static final int VerticalBigSmallTextView_vbsImgTop = 7;
    public static final int VerticalBigSmallTextView_vbsSmallFontColor = 8;
    public static final int VerticalBigSmallTextView_vbsSmallFontSize = 9;
    public static final int VerticalBigSmallTextView_vbsSmallFontText = 10;
    public static final int VerticalBigSmallTextView_vbsSpace = 11;
    public static final int VerticalFontTextView_vfBottomText = 0;
    public static final int VerticalFontTextView_vfBottomTextColor = 1;
    public static final int VerticalFontTextView_vfBottomTextSize = 2;
    public static final int VerticalFontTextView_vfGravity = 3;
    public static final int VerticalFontTextView_vfTopText = 4;
    public static final int VerticalFontTextView_vfTopTextColor = 5;
    public static final int VerticalFontTextView_vfTopTextSize = 6;
    ...
    public static final int XEditText_x_hidePwdDrawable = 3;
    public static final int XEditText_x_pattern = 4;
    public static final int XEditText_x_separator = 5;
    public static final int XEditText_x_showPwdDrawable = 6;
    public static final int XEditText_x_togglePwdDrawableEnable = 7;
    ...
    public static final int[] Battery = {R.attr.batteryBatteryColor, R.attr.batteryColor, R.attr.batteryHeaderColor, R.attr.batteryOrientation, R.attr.batteryPower};
    ...
    public static final int[] BigSmallTextView = {R.attr.bsBigFontColor, R.attr.bsBigFontSize, R.attr.bsBigFontText, R.attr.bsSmallFontColor, R.attr.bsSmallFontSize, R.attr.bsSmallFontText, R.attr.bsSpace};
    ...
    public static final int[] CircleDoubleProgressView = {R.attr.cdpvBlockAngle, R.attr.cdpvCapRound, R.attr.cdpvCirclePadding, R.attr.cdpvDuration, R.attr.cdpvLabelIcon, R.attr.cdpvLabelIconColor, R.attr.cdpvLabelIconSize, R.attr.cdpvLabelPaddingBottom, R.attr.cdpvLabelPaddingLeft, R.attr.cdpvLabelPaddingRight, R.attr.cdpvLabelPaddingTop, R.attr.cdpvLabelText, R.attr.cdpvLabelTextColor, R.attr.cdpvLabelTextSize, R.attr.cdpvMax1, R.attr.cdpvMax2, R.attr.cdpvNormal1Color, R.attr.cdpvNormal2Color, R.attr.cdpvNormalProgressStrokeWidth, R.attr.cdpvProgress1, R.attr.cdpvProgress1Color, R.attr.cdpvProgress2, R.attr.cdpvProgress2Color, R.attr.cdpvProgressStrokeWidth, R.attr.cdpvShowArrow, R.attr.cdpvShowLabel, R.attr.cdpvShowLabelIcon, R.attr.cdpvShowLabelIconShadow, R.attr.cdpvShowTick, R.attr.cdpvSpace, R.attr.cdpvStartAngle, R.attr.cdpvSweepAngle, R.attr.cdpvTickSplitAngle, R.attr.cdpvTurn};
    ...
    public static final int[] CircleProgress = {R.attr.decimalPointLength, R.attr.disableAngle, R.attr.duration, R.attr.isClockwise, R.attr.isDecimal, R.attr.isRound, R.attr.isShowPercentText, R.attr.maxProgress, R.attr.myTextColor, R.attr.myTextSize, R.attr.neiYuanColor, R.attr.progress, R.attr.ringColor, R.attr.ringProgressColor, R.attr.ringProgressSecondColor, R.attr.ringRadius, R.attr.ringWidth, R.attr.startAngle, R.attr.useAnimation};
    ...
    public static final int[] CircleProgressView = {R.attr.cpvBlockAngle, R.attr.cpvCapRound, R.attr.cpvCirclePadding, R.attr.cpvDuration, R.attr.cpvLabelIcon, R.attr.cpvLabelIconColor, R.attr.cpvLabelIconSize, R.attr.cpvLabelPaddingBottom, R.attr.cpvLabelPaddingLeft, R.attr.cpvLabelPaddingRight, R.attr.cpvLabelPaddingTop, R.attr.cpvLabelText, R.attr.cpvLabelTextColor, R.attr.cpvLabelTextSize, R.attr.cpvMax, R.attr.cpvNormalColor, R.attr.cpvNormalProgressStrokeWidth, R.attr.cpvProgress, R.attr.cpvProgressColor, R.attr.cpvProgressStrokeWidth, R.attr.cpvShowArrow, R.attr.cpvShowLabel, R.attr.cpvShowLabelIcon, R.attr.cpvShowLabelIconShadow, R.attr.cpvShowTick, R.attr.cpvStartAngle, R.attr.cpvSweepAngle, R.attr.cpvTickSplitAngle, R.attr.cpvTurn};
    public static final int[] CircleThreeProgressView = {R.attr.ctpvBlockAngle, R.attr.ctpvCapRound, R.attr.ctpvCirclePadding, R.attr.ctpvDuration, R.attr.ctpvIcon1, R.attr.ctpvIcon1BgColor, R.attr.ctpvIcon2, R.attr.ctpvIcon2BgColor, R.attr.ctpvIcon3, R.attr.ctpvIcon3BgColor, R.attr.ctpvLabelIcon, R.attr.ctpvLabelIconColor, R.attr.ctpvLabelIconSize, R.attr.ctpvLabelPaddingBottom, R.attr.ctpvLabelPaddingLeft, R.attr.ctpvLabelPaddingRight, R.attr.ctpvLabelPaddingTop, R.attr.ctpvLabelText, R.attr.ctpvLabelTextColor, R.attr.ctpvLabelTextSize, R.attr.ctpvMax1, R.attr.ctpvMax2, R.attr.ctpvMax3, R.attr.ctpvNormal1Color, R.attr.ctpvNormal2Color, R.attr.ctpvNormal3Color, R.attr.ctpvNormalProgressStrokeWidth, R.attr.ctpvProgress1, R.attr.ctpvProgress1Color, R.attr.ctpvProgress2, R.attr.ctpvProgress2Color, R.attr.ctpvProgress3, R.attr.ctpvProgress3Color, R.attr.ctpvProgressStrokeWidth, R.attr.ctpvShowArrow, R.attr.ctpvShowIconBg, R.attr.ctpvShowLabel, R.attr.ctpvShowLabelIcon, R.attr.ctpvShowLabelIconShadow, R.attr.ctpvShowTick, R.attr.ctpvSpace, R.attr.ctpvStartAngle, R.attr.ctpvSweepAngle, R.attr.ctpvTickSplitAngle, R.attr.ctpvTurn};
    ...
    public static final int[] ColorPannelView = {R.attr.ColorPannelColor, R.attr.ColorPannelViewRadius};
    public static final int[] ColorPickerView = {R.attr.actionMode, R.attr.alpha_flag, R.attr.alpha_selector, R.attr.debounceDuration, R.attr.initialColor, R.attr.palette, R.attr.preferenceName, R.attr.selector, R.attr.selector_size};
    ...
    public static final int[] DotTextView = {R.attr.dotColor, R.attr.dotGravity, R.attr.dotOffsetX, R.attr.dotOffsetY, R.attr.dotRadius, R.attr.isDebug, R.attr.showDot};
    public static final int[] DrawerArrowToggle = {R.attr.arrowHeadLength, R.attr.arrowShaftLength, R.attr.barLength, R.attr.color, R.attr.drawableSize, R.attr.gapBetweenBars, R.attr.spinBars, R.attr.thickness};
    public static final int[] DrawerLayout = {R.attr.elevation};
    public static final int[] ECGChartView = {R.attr.canLineBound, R.attr.ecgBackgroundColor, R.attr.ecgDrawColor, R.attr.ecgInnerColor, R.attr.ecgLineCount, R.attr.ecgOuterColor, R.attr.ecgportSpace, R.attr.isTouchable, R.attr.markTextStyle, R.attr.yOuterCellCounts};
    ...
    public static final int[] GradeRadioStyle = {R.attr.radSize};
    public static final int[] GradientColor = {android.R.attr.startColor, android.R.attr.endColor, android.R.attr.type, android.R.attr.centerX, android.R.attr.centerY, android.R.attr.gradientRadius, android.R.attr.tileMode, android.R.attr.centerColor, android.R.attr.startX, android.R.attr.startY, android.R.attr.endX, android.R.attr.endY};
    public static final int[] GradientColorItem = {android.R.attr.color, android.R.attr.offset};
    public static final int[] HLabelTextView = {R.attr.hlt_isRect, R.attr.hlt_label_color, R.attr.hlt_label_size, R.attr.hlt_label_text, R.attr.hlt_label_text_color, R.attr.hlt_label_text_size, R.attr.hlt_padding, R.attr.hlt_text, R.attr.hlt_text_color, R.attr.hlt_text_size};
    ...
    public static final int[] MuiltLayerCircleProgressView = {R.attr.mcp_c1_normal_color, R.attr.mcp_c1_progress_color, R.attr.mcp_c2_normal_color, R.attr.mcp_c2_progress_color, R.attr.mcp_c3_normal_color, R.attr.mcp_c3_progress_color, R.attr.mcp_height, R.attr.mcp_icon1, R.attr.mcp_icon1_bg_color, R.attr.mcp_icon2, R.attr.mcp_icon2_bg_color, R.attr.mcp_icon3, R.attr.mcp_icon3_bg_color, R.attr.mcp_icon_size, R.attr.mcp_isshow_icon, R.attr.mcp_normal_stroke_width, R.attr.mcp_progress_stroke_width, R.attr.mcp_space_width, R.attr.mcp_start_angle, R.attr.mcp_width};
    ...
    public static final int[] MyCircleBar = {R.attr.circle_center_color, R.attr.circle_end_color, R.attr.circle_gradient_on, R.attr.circle_hint_text_color, R.attr.circle_max_progress, R.attr.circle_ring_angle_type, R.attr.circle_ring_reached, R.attr.circle_ring_un_reached, R.attr.circle_ring_width, R.attr.circle_show_progress, R.attr.circle_show_scale_color, R.attr.circle_show_scale_on, R.attr.circle_show_text_color, R.attr.circle_start_color};
    public static final int[] MyCircleProgressBar = {R.attr.cpb_duration, R.attr.cpb_endColor, R.attr.cpb_startColor, R.attr.cpb_strokeWidth};
    ...
    public static final int[] NumberProgressBar = {R.attr.number_progress_current, R.attr.number_progress_max, R.attr.number_progress_reached_bar_height, R.attr.number_progress_reached_color, R.attr.number_progress_text_color, R.attr.number_progress_text_offset, R.attr.number_progress_text_size, R.attr.number_progress_text_visibility, R.attr.number_progress_unreached_bar_height, R.attr.number_progress_unreached_color};
    ...
    public static final int[] PasswordEditText = {R.attr.pet_disableIconAlpha, R.attr.pet_hoverShowsPw, R.attr.pet_iconHide, R.attr.pet_iconShow, R.attr.pet_iconlabel, R.attr.pet_nonMonospaceFont, R.attr.pet_showIconlabel};
    ...
    public static final int[] PolygonView = {R.attr.cv_border_color, R.attr.cv_fill_color, R.attr.cv_isRect, R.attr.cv_radius, R.attr.cv_show_stroke, R.attr.cv_stroke_width};
    ...
    public static final int[] QQSportView = {R.attr.circle_width, R.attr.in_bg_color, R.attr.out_bg_color, R.attr.text_color, R.attr.text_size};
    public static final int[] RadialViewGroup = {R.attr.materialCircleRadius};
    public static final int[] RadioGroupSelector = {R.attr.rgs_left_text, R.attr.rgs_right_text};
    public static final int[] RangeSeekBar = {R.attr.rsb_indicator_arrow_size, R.attr.rsb_indicator_background_color, R.attr.rsb_indicator_drawable, R.attr.rsb_indicator_height, R.attr.rsb_indicator_margin, R.attr.rsb_indicator_padding_bottom, R.attr.rsb_indicator_padding_left, R.attr.rsb_indicator_padding_right, R.attr.rsb_indicator_padding_top, R.attr.rsb_indicator_radius, R.attr.rsb_indicator_show_mode, R.attr.rsb_indicator_text_color, R.attr.rsb_indicator_text_size, R.attr.rsb_indicator_width, R.attr.rsb_label, R.attr.rsb_label_margin, R.attr.rsb_max, R.attr.rsb_min, R.attr.rsb_mode, R.attr.rsb_orientation, R.attr.rsb_progress_color, R.attr.rsb_progress_default_color, R.attr.rsb_progress_height, R.attr.rsb_progress_radius, R.attr.rsb_range_interval, R.attr.rsb_start_vaule, R.attr.rsb_thumb_drawable, R.attr.rsb_thumb_inactivated_drawable, R.attr.rsb_thumb_scale_ratio, R.attr.rsb_thumb_size, R.attr.rsb_tick_mark_gravity, R.attr.rsb_tick_mark_in_range_text_color, R.attr.rsb_tick_mark_label_text_array, R.attr.rsb_tick_mark_mode, R.attr.rsb_tick_mark_number, R.attr.rsb_tick_mark_text_array, R.attr.rsb_tick_mark_text_color, R.attr.rsb_tick_mark_text_margin, R.attr.rsb_tick_mark_text_size};
    ...
    public static final int[] RunningCircleProgressView = {R.attr.runCpvBlockAngle, R.attr.runCpvCapRound, R.attr.runCpvCirclePadding, R.attr.runCpvDuration, R.attr.runCpvLabelIcon, R.attr.runCpvLabelIconColor, R.attr.runCpvLabelIconSize, R.attr.runCpvLabelIconStrokeSize, R.attr.runCpvLabelPaddingBottom, R.attr.runCpvLabelPaddingLeft, R.attr.runCpvLabelPaddingRight, R.attr.runCpvLabelPaddingTop, R.attr.runCpvLabelText, R.attr.runCpvLabelTextColor, R.attr.runCpvLabelTextSize, R.attr.runCpvMax, R.attr.runCpvNormalColor, R.attr.runCpvNormalProgressStrokeWidth, R.attr.runCpvProgress, R.attr.runCpvProgressColor, R.attr.runCpvProgressStrokeWidth, R.attr.runCpvShaderColors, R.attr.runCpvShowArrow, R.attr.runCpvShowLabel, R.attr.runCpvShowLabelIcon, R.attr.runCpvShowLabelIconShadow, R.attr.runCpvShowTick, R.attr.runCpvStartAngle, R.attr.runCpvSweepAngle, R.attr.runCpvTickSplitAngle, R.attr.runCpvTurn};
    public static final int[] SMBanner = {R.attr.sm_banner_auto_loop, R.attr.sm_banner_indicator_gravity, R.attr.sm_banner_indicator_height, R.attr.sm_banner_indicator_margin, R.attr.sm_banner_indicator_marginBottom, R.attr.sm_banner_indicator_marginLeft, R.attr.sm_banner_indicator_marginRight, R.attr.sm_banner_indicator_marginTop, R.attr.sm_banner_indicator_normal_color, R.attr.sm_banner_indicator_normal_width, R.attr.sm_banner_indicator_radius, R.attr.sm_banner_indicator_selected_color, R.attr.sm_banner_indicator_selected_width, R.attr.sm_banner_indicator_space, R.attr.sm_banner_infinite_loop, R.attr.sm_banner_loop_time, R.attr.sm_banner_orientation, R.attr.sm_banner_radius, R.attr.sm_banner_round_bottom_left, R.attr.sm_banner_round_bottom_right, R.attr.sm_banner_round_top_left, R.attr.sm_banner_round_top_right};
    public static final int[] SMDrawableIndicator = {R.attr.sm_normal_drawable, R.attr.sm_selected_drawable};
    public static final int[] SMRoundedImageView = {R.attr.sm_riv_radius, R.attr.sm_round_bottom_left_radius, R.attr.sm_round_bottom_right_radius, R.attr.sm_round_top_left_radius, R.attr.sm_round_top_right_radius};
    public static final int[] ScalableImageView = {R.attr.scaleFrom, R.attr.scaleTo, R.attr.src};
    ...
    public static final int[] SelectorImageView = {R.attr.siv_filter_color};
    ...
    public static final int[] SignalView = {R.attr.rectBorderColor, R.attr.rectBorderWidth, R.attr.signalCount, R.attr.signalHighColor, R.attr.signalLowColor, R.attr.signalMiddleColor, R.attr.signalRectInterval, R.attr.signalTypeTextColor, R.attr.signalTypeTextSize};
    public static final int[] SleepChartStyle = {R.attr.gt_circle_radius, R.attr.gt_element_height, R.attr.gt_element_line_height, R.attr.gt_is_full_x_axis, R.attr.gt_is_full_y_axis, R.attr.gt_is_show_auxiliary_line, R.attr.gt_is_show_by_time, R.attr.gt_is_show_grid_line, R.attr.gt_is_show_marker, R.attr.gt_is_show_nav_bottom, R.attr.gt_is_show_x_axias, R.attr.gt_is_show_x_axias_text, R.attr.gt_is_show_y_axias, R.attr.gt_is_show_y_axias_text, R.attr.gt_is_touch_event, R.attr.gt_line_color, R.attr.gt_line_width, R.attr.gt_padding_top, R.attr.gt_scale, R.attr.gt_show_bubble, R.attr.gt_text_size};
    public static final int[] SleepViewStyle = {R.attr.sleep_background_color, R.attr.sleep_deeps_color, R.attr.sleep_lights_color, R.attr.sleep_wakeups_color};
    public static final int[] SlideLockView = {R.attr.lock_drawable, R.attr.lock_radius};
    ...
    public static final int[] VerticalBigSmallTextView = {R.attr.vbsBigFontColor, R.attr.vbsBigFontFamily, R.attr.vbsBigFontSize, R.attr.vbsBigFontText, R.attr.vbsBigLabelFontColor, R.attr.vbsBigLabelFontSize, R.attr.vbsBigLabelFontText, R.attr.vbsImgTop, R.attr.vbsSmallFontColor, R.attr.vbsSmallFontSize, R.attr.vbsSmallFontText, R.attr.vbsSpace};
    public static final int[] VerticalFontTextView = {R.attr.vfBottomText, R.attr.vfBottomTextColor, R.attr.vfBottomTextSize, R.attr.vfGravity, R.attr.vfTopText, R.attr.vfTopTextColor, R.attr.vfTopTextSize};
    ...
    public static final int[] XEditText = {R.attr.x_clearDrawable, R.attr.x_disableClear, R.attr.x_disableEmoji, R.attr.x_hidePwdDrawable, R.attr.x_pattern, R.attr.x_separator, R.attr.x_showPwdDrawable, R.attr.x_togglePwdDrawableEnable};
