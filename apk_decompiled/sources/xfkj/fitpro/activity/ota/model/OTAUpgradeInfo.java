...
public class OTAUpgradeInfo {
    ...
    public static class DataBean {
        ...
        public static List<DataBean> arrayDataBeanFromData(String str) {
            return (List) new qv0().fromJson(str, new TypeToken<ArrayList<DataBean>>() { // from class: xfkj.fitpro.activity.ota.model.OTAUpgradeInfo.DataBean.1
            }.getType());
        }
        ...
        public static List<DataBean> arrayDataBeanFromData(String str, String str2) {
            try {
                ...
                return (List) new qv0().fromJson(jSONObject.getString(str), new TypeToken<ArrayList<DataBean>>() { // from class: xfkj.fitpro.activity.ota.model.OTAUpgradeInfo.DataBean.2
                }.getType());
            } catch (JSONException e) {
                e.printStackTrace();
    ...
    public static OTAUpgradeInfo objectFromData(String str) {
        return (OTAUpgradeInfo) GsonUtils.fromJson(str, OTAUpgradeInfo.class);
    }
