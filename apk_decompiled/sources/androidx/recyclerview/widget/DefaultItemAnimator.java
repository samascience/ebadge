    ...
    public void runPendingAnimations() {
        ...
        if (!zIsEmpty2) {
            ...
            if (zIsEmpty) {
                ...
                be3.i0(arrayList.get(0).holder.itemView, runnable, getRemoveDuration());
            }
        }
        if (!zIsEmpty3) {
            ...
            if (zIsEmpty) {
                ...
                be3.i0(arrayList2.get(0).oldHolder.itemView, runnable2, getRemoveDuration());
            }
        }
        if (zIsEmpty4) {
            return;
        ...
        if (zIsEmpty && zIsEmpty2 && zIsEmpty3) {
            ...
            be3.i0(arrayList3.get(0).itemView, runnable3, (!zIsEmpty ? getRemoveDuration() : 0L) + Math.max(!zIsEmpty2 ? getMoveDuration() : 0L, zIsEmpty3 ? 0L : getChangeDuration()));
        }
    }
