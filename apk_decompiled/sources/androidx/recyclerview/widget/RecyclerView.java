...
public class RecyclerView extends ViewGroup implements sn1 {
    ...
    private tn1 mScrollingChildHelper;
    final State mState;
    ...
    public static abstract class Adapter<VH extends ViewHolder> {
        ...
        public final void bindViewHolder(VH vh, int i) {
            ...
            if (z) {
                ...
                vh.setFlags(1, 519);
                o43.a(RecyclerView.TRACE_BIND_VIEW_TAG);
            }
        ...
        public final VH createViewHolder(ViewGroup viewGroup, int i) {
            try {
                o43.a(RecyclerView.TRACE_CREATE_VIEW_TAG);
    ...
    public static abstract class LayoutManager {
        ...
        public int getLayoutDirection() {
            return be3.A(this.mRecyclerView);
        }
        ...
        public int getMinimumHeight() {
            return be3.B(this.mRecyclerView);
        }

        public int getMinimumWidth() {
            return be3.C(this.mRecyclerView);
        }
        ...
        void onInitializeAccessibilityNodeInfo(m2 m2Var) {
            RecyclerView recyclerView = this.mRecyclerView;
            onInitializeAccessibilityNodeInfo(recyclerView.mRecycler, recyclerView.mState, m2Var);
        }

        void onInitializeAccessibilityNodeInfoForItem(View view, m2 m2Var) {
            ViewHolder childViewHolderInt = RecyclerView.getChildViewHolderInt(view);
            if (childViewHolderInt == null || childViewHolderInt.isRemoved() || this.mChildHelper.isHidden(childViewHolderInt.itemView)) {
                return;
            }
            RecyclerView recyclerView = this.mRecyclerView;
            onInitializeAccessibilityNodeInfoForItem(recyclerView.mRecycler, recyclerView.mState, view, m2Var);
        }
        ...
        public void onInitializeAccessibilityNodeInfo(Recycler recycler, State state, m2 m2Var) {
            ...
            m2Var.l0(m2.e.b(getRowCountForAccessibility(recycler, state), getColumnCountForAccessibility(recycler, state), isLayoutHierarchical(recycler, state), getSelectionModeForAccessibility(recycler, state)));
        }
        ...
        public void onInitializeAccessibilityNodeInfoForItem(Recycler recycler, State state, View view, m2 m2Var) {
        }
    ...
    public final class Recycler {
        ...
        void addViewHolderToRecycledViewPool(ViewHolder viewHolder, boolean z) {
            ...
            if (recyclerViewAccessibilityDelegate != null) {
                t1 itemDelegate = recyclerViewAccessibilityDelegate.getItemDelegate();
                be3.p0(view, itemDelegate instanceof RecyclerViewAccessibilityDelegate.ItemDelegate ? ((RecyclerViewAccessibilityDelegate.ItemDelegate) itemDelegate).getAndRemoveOriginalDelegateForItem(view) : null);
            }
            if (z) {
        ...
        void triggerUpdateProcessor() {
            if (RecyclerView.POST_UPDATES_ON_ANIMATION) {
                ...
                if (recyclerView.mHasFixedSize && recyclerView.mIsAttached) {
                    be3.h0(recyclerView, recyclerView.mUpdateChildViewsRunnable);
                    return;
                }
            }
            RecyclerView recyclerView2 = RecyclerView.this;
    ...
    public static abstract class ViewHolder {
        ...
        boolean doesTransientStatePreventRecycling() {
            return (this.mFlags & 16) == 0 && be3.Q(this.itemView);
        }
        ...
        void onEnteredHiddenState(RecyclerView recyclerView) {
            ...
            if (i != -1) {
                ...
                this.mWasImportantForAccessibilityBeforeHidden = be3.y(this.itemView);
            }
        ...
        void stopIgnoring() {
            this.mFlags &= GifError.ERR_UNKNOWN_CHIP;
        }
    ...
    private void dispatchContentChangedIfNecessary() {
        ...
        u1.b(accessibilityEventObtain, i);
    ...
    private tn1 getScrollingChildHelper() {
        if (this.mScrollingChildHelper == null) {
            this.mScrollingChildHelper = new tn1(this);
        }
    ...
    private void pullGlows(float f, float f2, float f3, float f4) {
        ...
        if (f2 >= 0.0f) {
            if (f2 > 0.0f) {
                ensureRightGlow();
                cf0.c(this.mRightGlow, f2 / getWidth(), f3 / getHeight());
            } else {
                z = false;
            }
            if (f4 < 0.0f) {
                ensureTopGlow();
                cf0.c(this.mTopGlow, (-f4) / getHeight(), f / getWidth());
            } else if (f4 > 0.0f) {
                ensureBottomGlow();
                cf0.c(this.mBottomGlow, f4 / getHeight(), 1.0f - (f / getWidth()));
            } else {
                z2 = z;
            }
        ...
        ensureLeftGlow();
        cf0.c(this.mLeftGlow, (-f2) / getWidth(), 1.0f - (f3 / getHeight()));
        z = true;
        if (f4 < 0.0f) {
            ensureTopGlow();
            cf0.c(this.mTopGlow, (-f4) / getHeight(), f / getWidth());
    ...
    public void addRecyclerListener(RecyclerListener recyclerListener) {
        b52.b(recyclerListener != null, "'listener' arg cannot be null.");
    ...
    void assertNotInLayoutOrScroll(String str) {
        ...
        if (this.mDispatchScrollCounter > 0) {
            Log.w(TAG, "Cannot call this method in a scroll callback. Scroll callbacks mightbe run during a measure & layout pass where you cannot change theRecyclerView data. Any method call that might change the structureof the RecyclerView or the adapter contents should be postponed tothe next frame.", new IllegalStateException(Constants.STR_EMPTY + exceptionLabel()));
        }
    }
    ...
    void consumePendingUpdateOperations() {
        if (!this.mFirstLayoutComplete || this.mDataSetHasChangedAfterLayout) {
            o43.a(TRACE_ON_DATA_SET_CHANGE_LAYOUT_TAG);
            dispatchLayout();
            o43.b();
            return;
        }
        if (this.mAdapterHelper.hasPendingUpdates()) {
            ...
            o43.a(TRACE_HANDLE_ADAPTER_UPDATES_TAG);
            startInterceptRequestLayout();
            onEnterLayoutOrScroll();
            this.mAdapterHelper.preProcess();
    ...
    void defaultOnMeasure(int i, int i2) {
        setMeasuredDimension(LayoutManager.chooseSize(i, getPaddingLeft() + getPaddingRight(), be3.C(this)), LayoutManager.chooseSize(i2, getPaddingTop() + getPaddingBottom(), be3.B(this)));
    }
    ...
    void postAnimationRunner() {
        ...
        be3.h0(this, this.mItemAnimatorRunner);
    ...
    boolean scrollByInternal(int i, int i2, MotionEvent motionEvent, int i3) {
        ...
        if (getOverScrollMode() != 2) {
            if (motionEvent != null && !al1.a(motionEvent, 8194)) {
    ...
    public void setAccessibilityDelegateCompat(RecyclerViewAccessibilityDelegate recyclerViewAccessibilityDelegate) {
        ...
        be3.p0(this, recyclerViewAccessibilityDelegate);
    }
    ...
    boolean shouldDeferAccessibilityEvent(AccessibilityEvent accessibilityEvent) {
        ...
        int iA = accessibilityEvent != null ? u1.a(accessibilityEvent) : 0;
    ...
    public RecyclerView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mTouchSlop = viewConfiguration.getScaledTouchSlop();
        this.mScaledHorizontalScrollFactor = ee3.e(viewConfiguration, context);
        this.mScaledVerticalScrollFactor = ee3.h(viewConfiguration, context);
        ...
        be3.n0(this, context, iArr2, attributeSet, typedArrayObtainStyledAttributes2, i, 0);
