...
class z extends tg2 implements View.OnClickListener {
    ...
    private Drawable s(String str) {
        ...
        try {
            ...
            String str2 = "android.resource://" + this.n.getPackageName() + WatchConstant.FAT_FS_ROOT + i;
            Drawable drawableK = k(str2);
            if (drawableK != null) {
                return drawableK;
            }
            Drawable drawableE = q30.e(this.n, i);
            A(str2, drawableE);
            return drawableE;
        } catch (Resources.NotFoundException unused) {
    ...
    public Cursor d(CharSequence charSequence) {
        String string = charSequence == null ? Constants.STR_EMPTY : charSequence.toString();
    ...
    @Override // defpackage.g50, android.widget.BaseAdapter, android.widget.SpinnerAdapter
    ...
    @Override // defpackage.g50, android.widget.Adapter
    ...
    @Override // defpackage.tg2, defpackage.g50
    public View h(Context context, Cursor cursor, ViewGroup viewGroup) {
        View viewH = super.h(context, cursor, viewGroup);
        viewH.setTag(new a(viewH));
        ((ImageView) viewH.findViewById(R$id.edit_query)).setImageResource(this.p);
        return viewH;
    }
    ...
    Cursor v(SearchableInfo searchableInfo, String str, int i) {
        ...
        Uri.Builder builderFragment = new Uri.Builder().scheme("content").authority(suggestAuthority).query(Constants.STR_EMPTY).fragment(Constants.STR_EMPTY);
