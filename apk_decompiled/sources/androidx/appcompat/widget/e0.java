...
public class e0 {
    ...
    public ColorStateList c(int i) {
        ...
        return (!this.b.hasValue(i) || (resourceId = this.b.getResourceId(i, 0)) == 0 || (colorStateListA = v8.a(this.a, resourceId)) == null) ? this.b.getColorStateList(i) : colorStateListA;
    }
    ...
    public Drawable g(int i) {
        int resourceId;
        return (!this.b.hasValue(i) || (resourceId = this.b.getResourceId(i, 0)) == 0) ? this.b.getDrawable(i) : v8.b(this.a, resourceId);
    }
    ...
    public Typeface j(int i, int i2, bh2.e eVar) {
        ...
        return bh2.h(this.a, resourceId, this.c, i2, eVar);
    }
