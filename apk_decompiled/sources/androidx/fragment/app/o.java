...
class o extends p {
    ...
    class c implements Transition.TransitionListener {
        ...
        public void onTransitionStart(Transition transition) {
            Object obj = this.a;
            if (obj != null) {
                o.this.w(obj, this.b, null);
            }
            Object obj2 = this.c;
            if (obj2 != null) {
                o.this.w(obj2, this.d, null);
            }
            Object obj3 = this.e;
            if (obj3 != null) {
                o.this.w(obj3, this.f, null);
            }
        }
    }
    ...
    private static boolean v(Transition transition) {
        return (p.i(transition.getTargetIds()) && p.i(transition.getTargetNames()) && p.i(transition.getTargetTypes())) ? false : true;
    }
    ...
    public void b(Object obj, ArrayList arrayList) {
        ...
        if (v(transition) || !p.i(transition.getTargets())) {
            return;
        }
    ...
    public void s(Object obj, View view, ArrayList arrayList) {
        ...
        int size = arrayList.size();
        for (int i = 0; i < size; i++) {
            p.d(targets, (View) arrayList.get(i));
        }
        targets.add(view);
        arrayList.add(view);
