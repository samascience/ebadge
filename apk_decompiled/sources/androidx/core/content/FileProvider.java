...
public class FileProvider extends ContentProvider {
    ...
    private static final File f = new File(WatchConstant.FAT_FS_ROOT);
    ...
    static class c implements b {
        ...
        private boolean d(String str, String str2) {
            ...
            if (!strK.equals(strK2)) {
                if (!strK.startsWith(strK2 + JsonPointer.SEPARATOR)) {
                    return false;
                }
            }
            return true;
        ...
        public Uri b(File file) {
            try {
                ...
                return new Uri.Builder().scheme("content").authority(this.a).encodedPath(Uri.encode((String) entry.getKey()) + JsonPointer.SEPARATOR + Uri.encode(path2.endsWith(WatchConstant.FAT_FS_ROOT) ? canonicalPath.substring(path2.length()) : canonicalPath.substring(path2.length() + 1), WatchConstant.FAT_FS_ROOT)).build();
            } catch (IOException unused) {
    ...
    private b f() {
        ...
        synchronized (this.a) {
            try {
                tt1.d(this.b, "mAuthority is null. Did you override attachInfo and did not call super.attachInfo()?");
                if (this.c == null) {
